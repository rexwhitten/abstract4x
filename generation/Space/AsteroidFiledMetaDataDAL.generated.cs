namespace Space.Data.Space {
    ...
    public partial class AsteroidFiledMetaDataDAL : Space.Data.DataAccessBase {
        
        public AsteroidFiledMetaDataDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private AsteroidFiledMetaData Fill(System.Data.DataRow row) {
            AsteroidFiledMetaData obj = new AsteroidFiledMetaData();
        ...
        public virtual Collection<AsteroidFiledMetaData> SelectObjects(AsteroidFiledMetaData query) {
            Collection<AsteroidFiledMetaData> objs = new Collection<AsteroidFiledMetaData>();
...
while(e.MoveNext()) { 
 ...
 AsteroidFiledMetaData obj = Fill(row);
 objs.Add(obj);
 }
            return objs;
        }
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledMetaData");
        ...
        public virtual System.Data.DataSet Select(AsteroidFiledMetaData query) {
            this.Access.CreateProcedureCommand("ssp_AsteroidFiledMetaData");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pAsteroidFiledSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledMetaData");
        ...
        // Updates a Record
        public virtual int Update(AsteroidFiledMetaData query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledMetaData");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(AsteroidFiledMetaData query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledMetaData");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pAsteroidFiledSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledMetaData");
        ...
        // Inserts a record
        public virtual int Insert(AsteroidFiledMetaData query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledMetaData");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
