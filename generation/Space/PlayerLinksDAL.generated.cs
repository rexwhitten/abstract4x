namespace Space.Data.Space {
    ...
    public partial class PlayerLinksDAL : Space.Data.DataAccessBase {
        
        public PlayerLinksDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private PlayerLinks Fill(System.Data.DataRow row) {
            PlayerLinks obj = new PlayerLinks();
            ...
            if ((row["ParentPlayerSysId"] != System.DBNull.Value)) {
                obj.ParentPlayerSysId = ((int?)(row["ParentPlayerSysId"]));
            }
            if ((row["ChildPlayerSysId"] != System.DBNull.Value)) {
                obj.ChildPlayerSysId = ((int?)(row["ChildPlayerSysId"]));
            }
        ...
        public virtual Collection<PlayerLinks> SelectObjects(PlayerLinks query) {
            Collection<PlayerLinks> objs = new Collection<PlayerLinks>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_PlayerLinks");
        ...
        public virtual System.Data.DataSet Select(PlayerLinks query) {
            this.Access.CreateProcedureCommand("ssp_PlayerLinks");
            if (query.SysId == null) {
            ...
            if (query.ParentPlayerSysId == null) {
                this.Access.AddParameter("ParentPlayerSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ParentPlayerSysId",query.ParentPlayerSysId, ParameterDirection.Input);
            }
            if (query.ChildPlayerSysId == null) {
                this.Access.AddParameter("ChildPlayerSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ChildPlayerSysId",query.ChildPlayerSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentPlayerSysId, System.Nullable<int> pChildPlayerSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_PlayerLinks");
            ...
            this.Access.AddParameter("ParentPlayerSysId", pParentPlayerSysId, ParameterDirection.Input);
            this.Access.AddParameter("ChildPlayerSysId", pChildPlayerSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(PlayerLinks query) {
            this.Access.CreateProcedureCommand("cp_PlayerLinks");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(PlayerLinks query) {
            this.Access.CreateProcedureCommand("cp_PlayerLinks");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentPlayerSysId, System.Nullable<int> pChildPlayerSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_PlayerLinks");
        ...
        // Inserts a record
        public virtual int Insert(PlayerLinks query) {
            this.Access.CreateProcedureCommand("cp_PlayerLinks");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
