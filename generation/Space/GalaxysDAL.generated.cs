namespace Space.Data.Space {
    ...
    public partial class GalaxysDAL : Space.Data.DataAccessBase {
        ...
        private Galaxys Fill(System.Data.DataRow row) {
            Galaxys obj = new Galaxys();
            if ((row["SysId"] != System.DBNull.Value)) {
                obj.SysId = ((int?)(row["SysId"]));
            }
            if ((row["GalaxyStatusSysId"] != System.DBNull.Value)) {
                obj.GalaxyStatusSysId = ((int?)(row["GalaxyStatusSysId"]));
            }
            if ((row["GalaxyTypeSysId"] != System.DBNull.Value)) {
                obj.GalaxyTypeSysId = ((int?)(row["GalaxyTypeSysId"]));
            }
        ...
        public virtual Collection<Galaxys> SelectObjects(Galaxys query) {
            Collection<Galaxys> objs = new Collection<Galaxys>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_Galaxys");
        ...
        public virtual System.Data.DataSet Select(Galaxys query) {
            this.Access.CreateProcedureCommand("ssp_Galaxys");
            if (query.SysId == null) {
            ...
            if (query.GalaxyStatusSysId == null) {
                this.Access.AddParameter("GalaxyStatusSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("GalaxyStatusSysId",query.GalaxyStatusSysId, ParameterDirection.Input);
            }
            if (query.GalaxyTypeSysId == null) {
                this.Access.AddParameter("GalaxyTypeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("GalaxyTypeSysId",query.GalaxyTypeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pGalaxyStatusSysId, System.Nullable<int> pGalaxyTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Galaxys");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            this.Access.AddParameter("SysId", pSysId, ParameterDirection.Input);
            this.Access.AddParameter("GalaxyStatusSysId", pGalaxyStatusSysId, ParameterDirection.Input);
            this.Access.AddParameter("GalaxyTypeSysId", pGalaxyTypeSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(Galaxys query) {
            this.Access.CreateProcedureCommand("cp_Galaxys");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(Galaxys query) {
            this.Access.CreateProcedureCommand("cp_Galaxys");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pGalaxyStatusSysId, System.Nullable<int> pGalaxyTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Galaxys");
        ...
        // Inserts a record
        public virtual int Insert(Galaxys query) {
            this.Access.CreateProcedureCommand("cp_Galaxys");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
