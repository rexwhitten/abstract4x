namespace Space.Data.Space {
    ...
    public partial class StarTypesDAL : Space.Data.DataAccessBase {
        ...
        private StarTypes Fill(System.Data.DataRow row) {
            StarTypes obj = new StarTypes();
        ...
        public virtual Collection<StarTypes> SelectObjects(StarTypes query) {
            Collection<StarTypes> objs = new Collection<StarTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_StarTypes");
        ...
        public virtual System.Data.DataSet Select(StarTypes query) {
            this.Access.CreateProcedureCommand("ssp_StarTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(StarTypes query) {
            this.Access.CreateProcedureCommand("cp_StarTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(StarTypes query) {
            this.Access.CreateProcedureCommand("cp_StarTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(StarTypes query) {
            this.Access.CreateProcedureCommand("cp_StarTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
