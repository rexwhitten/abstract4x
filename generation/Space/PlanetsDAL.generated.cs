namespace Space.Data.Space {
    ...
    public partial class PlanetsDAL : Space.Data.DataAccessBase {
        ...
        private Planets Fill(System.Data.DataRow row) {
            Planets obj = new Planets();
            if ((row["SysId"] != System.DBNull.Value)) {
                obj.SysId = ((int?)(row["SysId"]));
            }
            if ((row["PlanetStatusSysId"] != System.DBNull.Value)) {
                obj.PlanetStatusSysId = ((int?)(row["PlanetStatusSysId"]));
            }
            if ((row["PlanetTypeSysId"] != System.DBNull.Value)) {
                obj.PlanetTypeSysId = ((int?)(row["PlanetTypeSysId"]));
            }
        ...
        public virtual Collection<Planets> SelectObjects(Planets query) {
            Collection<Planets> objs = new Collection<Planets>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_Planets");
        ...
        public virtual System.Data.DataSet Select(Planets query) {
            this.Access.CreateProcedureCommand("ssp_Planets");
            if (query.SysId == null) {
            ...
            if (query.PlanetStatusSysId == null) {
                this.Access.AddParameter("PlanetStatusSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("PlanetStatusSysId",query.PlanetStatusSysId, ParameterDirection.Input);
            }
            if (query.PlanetTypeSysId == null) {
                this.Access.AddParameter("PlanetTypeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("PlanetTypeSysId",query.PlanetTypeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pPlanetStatusSysId, System.Nullable<int> pPlanetTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Planets");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            this.Access.AddParameter("SysId", pSysId, ParameterDirection.Input);
            this.Access.AddParameter("PlanetStatusSysId", pPlanetStatusSysId, ParameterDirection.Input);
            this.Access.AddParameter("PlanetTypeSysId", pPlanetTypeSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(Planets query) {
            this.Access.CreateProcedureCommand("cp_Planets");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(Planets query) {
            this.Access.CreateProcedureCommand("cp_Planets");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pPlanetStatusSysId, System.Nullable<int> pPlanetTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Planets");
        ...
        // Inserts a record
        public virtual int Insert(Planets query) {
            this.Access.CreateProcedureCommand("cp_Planets");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
