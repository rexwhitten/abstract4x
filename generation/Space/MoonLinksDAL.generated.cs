namespace Space.Data.Space {
    ...
    public partial class MoonLinksDAL : Space.Data.DataAccessBase {
        ...
        private MoonLinks Fill(System.Data.DataRow row) {
            MoonLinks obj = new MoonLinks();
            ...
            if ((row["ParentMoonSysId"] != System.DBNull.Value)) {
                obj.ParentMoonSysId = ((int?)(row["ParentMoonSysId"]));
            }
            if ((row["ChildMoonSysId"] != System.DBNull.Value)) {
                obj.ChildMoonSysId = ((int?)(row["ChildMoonSysId"]));
            }
        ...
        public virtual Collection<MoonLinks> SelectObjects(MoonLinks query) {
            Collection<MoonLinks> objs = new Collection<MoonLinks>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_MoonLinks");
        ...
        public virtual System.Data.DataSet Select(MoonLinks query) {
            this.Access.CreateProcedureCommand("ssp_MoonLinks");
            if (query.SysId == null) {
            ...
            if (query.ParentMoonSysId == null) {
                this.Access.AddParameter("ParentMoonSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ParentMoonSysId",query.ParentMoonSysId, ParameterDirection.Input);
            }
            if (query.ChildMoonSysId == null) {
                this.Access.AddParameter("ChildMoonSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ChildMoonSysId",query.ChildMoonSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentMoonSysId, System.Nullable<int> pChildMoonSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_MoonLinks");
            ...
            this.Access.AddParameter("ParentMoonSysId", pParentMoonSysId, ParameterDirection.Input);
            this.Access.AddParameter("ChildMoonSysId", pChildMoonSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(MoonLinks query) {
            this.Access.CreateProcedureCommand("cp_MoonLinks");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(MoonLinks query) {
            this.Access.CreateProcedureCommand("cp_MoonLinks");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentMoonSysId, System.Nullable<int> pChildMoonSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_MoonLinks");
        ...
        // Inserts a record
        public virtual int Insert(MoonLinks query) {
            this.Access.CreateProcedureCommand("cp_MoonLinks");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
