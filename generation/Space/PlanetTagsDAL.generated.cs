namespace Space.Data.Space {
    ...
    public partial class PlanetTagsDAL : Space.Data.DataAccessBase {
        
        public PlanetTagsDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private PlanetTags Fill(System.Data.DataRow row) {
            PlanetTags obj = new PlanetTags();
        ...
        public virtual Collection<PlanetTags> SelectObjects(PlanetTags query) {
            Collection<PlanetTags> objs = new Collection<PlanetTags>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_PlanetTags");
        ...
        public virtual System.Data.DataSet Select(PlanetTags query) {
            this.Access.CreateProcedureCommand("ssp_PlanetTags");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pPlanetSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_PlanetTags");
        ...
        // Updates a Record
        public virtual int Update(PlanetTags query) {
            this.Access.CreateProcedureCommand("cp_PlanetTags");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(PlanetTags query) {
            this.Access.CreateProcedureCommand("cp_PlanetTags");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pPlanetSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_PlanetTags");
        ...
        // Inserts a record
        public virtual int Insert(PlanetTags query) {
            this.Access.CreateProcedureCommand("cp_PlanetTags");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
