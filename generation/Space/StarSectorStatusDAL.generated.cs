namespace Space.Data.Space {
    ...
    public partial class StarSectorStatusDAL : Space.Data.DataAccessBase {
        
        public StarSectorStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private StarSectorStatus Fill(System.Data.DataRow row) {
            StarSectorStatus obj = new StarSectorStatus();
        ...
        public virtual Collection<StarSectorStatus> SelectObjects(StarSectorStatus query) {
            Collection<StarSectorStatus> objs = new Collection<StarSectorStatus>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_StarSectorStatus");
        ...
        public virtual System.Data.DataSet Select(StarSectorStatus query) {
            this.Access.CreateProcedureCommand("ssp_StarSectorStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(StarSectorStatus query) {
            this.Access.CreateProcedureCommand("cp_StarSectorStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(StarSectorStatus query) {
            this.Access.CreateProcedureCommand("cp_StarSectorStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(StarSectorStatus query) {
            this.Access.CreateProcedureCommand("cp_StarSectorStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
