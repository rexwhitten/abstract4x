namespace Space.Data.Space {
    ...
    public partial class GalaxyTagsDAL : Space.Data.DataAccessBase {
        
        public GalaxyTagsDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private GalaxyTags Fill(System.Data.DataRow row) {
            GalaxyTags obj = new GalaxyTags();
        ...
        public virtual Collection<GalaxyTags> SelectObjects(GalaxyTags query) {
            Collection<GalaxyTags> objs = new Collection<GalaxyTags>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_GalaxyTags");
        ...
        public virtual System.Data.DataSet Select(GalaxyTags query) {
            this.Access.CreateProcedureCommand("ssp_GalaxyTags");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pGalaxySysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_GalaxyTags");
        ...
        // Updates a Record
        public virtual int Update(GalaxyTags query) {
            this.Access.CreateProcedureCommand("cp_GalaxyTags");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(GalaxyTags query) {
            this.Access.CreateProcedureCommand("cp_GalaxyTags");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pGalaxySysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_GalaxyTags");
        ...
        // Inserts a record
        public virtual int Insert(GalaxyTags query) {
            this.Access.CreateProcedureCommand("cp_GalaxyTags");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
