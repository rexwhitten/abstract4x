namespace Space.Data.Space {
    ...
    public partial class AsteroidFiledsDAL : Space.Data.DataAccessBase {
        
        public AsteroidFiledsDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private AsteroidFileds Fill(System.Data.DataRow row) {
            AsteroidFileds obj = new AsteroidFileds();
            if ((row["SysId"] != System.DBNull.Value)) {
                obj.SysId = ((int?)(row["SysId"]));
            }
            if ((row["AsteroidFiledStatusSysId"] != System.DBNull.Value)) {
                obj.AsteroidFiledStatusSysId = ((int?)(row["AsteroidFiledStatusSysId"]));
            }
            if ((row["AsteroidFiledTypeSysId"] != System.DBNull.Value)) {
                obj.AsteroidFiledTypeSysId = ((int?)(row["AsteroidFiledTypeSysId"]));
            }
        ...
        public virtual Collection<AsteroidFileds> SelectObjects(AsteroidFileds query) {
            Collection<AsteroidFileds> objs = new Collection<AsteroidFileds>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_AsteroidFileds");
        ...
        public virtual System.Data.DataSet Select(AsteroidFileds query) {
            this.Access.CreateProcedureCommand("ssp_AsteroidFileds");
            if (query.SysId == null) {
            ...
            if (query.AsteroidFiledStatusSysId == null) {
                this.Access.AddParameter("AsteroidFiledStatusSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("AsteroidFiledStatusSysId",query.AsteroidFiledStatusSysId, ParameterDirection.Input);
            }
            if (query.AsteroidFiledTypeSysId == null) {
                this.Access.AddParameter("AsteroidFiledTypeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("AsteroidFiledTypeSysId",query.AsteroidFiledTypeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(AsteroidFileds query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFileds");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(AsteroidFileds query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFileds");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pAsteroidFiledStatusSysId, System.Nullable<int> pAsteroidFiledTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_AsteroidFileds");
        ...
        // Inserts a record
        public virtual int Insert(AsteroidFileds query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFileds");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
