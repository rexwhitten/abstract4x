namespace Space.Data.Space {
    ...
    public partial class StarStatusDAL : Space.Data.DataAccessBase {
        
        public StarStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private StarStatus Fill(System.Data.DataRow row) {
            StarStatus obj = new StarStatus();
        ...
        public virtual Collection<StarStatus> SelectObjects(StarStatus query) {
            Collection<StarStatus> objs = new Collection<StarStatus>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_StarStatus");
        ...
        public virtual System.Data.DataSet Select(StarStatus query) {
            this.Access.CreateProcedureCommand("ssp_StarStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(StarStatus query) {
            this.Access.CreateProcedureCommand("cp_StarStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(StarStatus query) {
            this.Access.CreateProcedureCommand("cp_StarStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(StarStatus query) {
            this.Access.CreateProcedureCommand("cp_StarStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
