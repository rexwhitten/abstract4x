namespace Space.Data.Space {
    ...
    public partial class ActorStatusDAL : Space.Data.DataAccessBase {
        
        public ActorStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private ActorStatus Fill(System.Data.DataRow row) {
            ActorStatus obj = new ActorStatus();
        ...
        public virtual Collection<ActorStatus> SelectObjects(ActorStatus query) {
            Collection<ActorStatus> objs = new Collection<ActorStatus>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_ActorStatus");
        ...
        public virtual System.Data.DataSet Select(ActorStatus query) {
            this.Access.CreateProcedureCommand("ssp_ActorStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(ActorStatus query) {
            this.Access.CreateProcedureCommand("cp_ActorStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(ActorStatus query) {
            this.Access.CreateProcedureCommand("cp_ActorStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(ActorStatus query) {
            this.Access.CreateProcedureCommand("cp_ActorStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
