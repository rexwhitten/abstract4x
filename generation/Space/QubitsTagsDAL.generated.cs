namespace Space.Data.Space {
    ...
    public partial class QubitsTagsDAL : Space.Data.DataAccessBase {
        
        public QubitsTagsDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private QubitsTags Fill(System.Data.DataRow row) {
            QubitsTags obj = new QubitsTags();
        ...
        public virtual Collection<QubitsTags> SelectObjects(QubitsTags query) {
            Collection<QubitsTags> objs = new Collection<QubitsTags>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_QubitsTags");
        ...
        public virtual System.Data.DataSet Select(QubitsTags query) {
            this.Access.CreateProcedureCommand("ssp_QubitsTags");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pQubitsSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_QubitsTags");
        ...
        // Updates a Record
        public virtual int Update(QubitsTags query) {
            this.Access.CreateProcedureCommand("cp_QubitsTags");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(QubitsTags query) {
            this.Access.CreateProcedureCommand("cp_QubitsTags");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pQubitsSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_QubitsTags");
        ...
        // Inserts a record
        public virtual int Insert(QubitsTags query) {
            this.Access.CreateProcedureCommand("cp_QubitsTags");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
