namespace Space.Data.Space {
    ...
    public partial class GalaxyLinksDAL : Space.Data.DataAccessBase {
        
        public GalaxyLinksDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private GalaxyLinks Fill(System.Data.DataRow row) {
            GalaxyLinks obj = new GalaxyLinks();
            ...
            if ((row["ParentGalaxySysId"] != System.DBNull.Value)) {
                obj.ParentGalaxySysId = ((int?)(row["ParentGalaxySysId"]));
            }
            if ((row["ChildGalaxySysId"] != System.DBNull.Value)) {
                obj.ChildGalaxySysId = ((int?)(row["ChildGalaxySysId"]));
            }
        ...
        public virtual Collection<GalaxyLinks> SelectObjects(GalaxyLinks query) {
            Collection<GalaxyLinks> objs = new Collection<GalaxyLinks>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_GalaxyLinks");
        ...
        public virtual System.Data.DataSet Select(GalaxyLinks query) {
            this.Access.CreateProcedureCommand("ssp_GalaxyLinks");
            if (query.SysId == null) {
            ...
            if (query.ParentGalaxySysId == null) {
                this.Access.AddParameter("ParentGalaxySysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ParentGalaxySysId",query.ParentGalaxySysId, ParameterDirection.Input);
            }
            if (query.ChildGalaxySysId == null) {
                this.Access.AddParameter("ChildGalaxySysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ChildGalaxySysId",query.ChildGalaxySysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentGalaxySysId, System.Nullable<int> pChildGalaxySysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_GalaxyLinks");
            ...
            this.Access.AddParameter("ParentGalaxySysId", pParentGalaxySysId, ParameterDirection.Input);
            this.Access.AddParameter("ChildGalaxySysId", pChildGalaxySysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(GalaxyLinks query) {
            this.Access.CreateProcedureCommand("cp_GalaxyLinks");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(GalaxyLinks query) {
            this.Access.CreateProcedureCommand("cp_GalaxyLinks");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentGalaxySysId, System.Nullable<int> pChildGalaxySysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_GalaxyLinks");
        ...
        // Inserts a record
        public virtual int Insert(GalaxyLinks query) {
            this.Access.CreateProcedureCommand("cp_GalaxyLinks");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
