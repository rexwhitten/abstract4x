namespace Space.Data.Space {
    ...
    public partial class MoonsDAL : Space.Data.DataAccessBase {
        ...
        private Moons Fill(System.Data.DataRow row) {
            Moons obj = new Moons();
            if ((row["SysId"] != System.DBNull.Value)) {
                obj.SysId = ((int?)(row["SysId"]));
            }
            if ((row["MoonStatusSysId"] != System.DBNull.Value)) {
                obj.MoonStatusSysId = ((int?)(row["MoonStatusSysId"]));
            }
            if ((row["MoonTypeSysId"] != System.DBNull.Value)) {
                obj.MoonTypeSysId = ((int?)(row["MoonTypeSysId"]));
            }
        ...
        public virtual Collection<Moons> SelectObjects(Moons query) {
            Collection<Moons> objs = new Collection<Moons>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_Moons");
        ...
        public virtual System.Data.DataSet Select(Moons query) {
            this.Access.CreateProcedureCommand("ssp_Moons");
            if (query.SysId == null) {
            ...
            if (query.MoonStatusSysId == null) {
                this.Access.AddParameter("MoonStatusSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("MoonStatusSysId",query.MoonStatusSysId, ParameterDirection.Input);
            }
            if (query.MoonTypeSysId == null) {
                this.Access.AddParameter("MoonTypeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("MoonTypeSysId",query.MoonTypeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pMoonStatusSysId, System.Nullable<int> pMoonTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Moons");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            this.Access.AddParameter("SysId", pSysId, ParameterDirection.Input);
            this.Access.AddParameter("MoonStatusSysId", pMoonStatusSysId, ParameterDirection.Input);
            this.Access.AddParameter("MoonTypeSysId", pMoonTypeSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(Moons query) {
            this.Access.CreateProcedureCommand("cp_Moons");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(Moons query) {
            this.Access.CreateProcedureCommand("cp_Moons");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pMoonStatusSysId, System.Nullable<int> pMoonTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Moons");
        ...
        // Inserts a record
        public virtual int Insert(Moons query) {
            this.Access.CreateProcedureCommand("cp_Moons");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
