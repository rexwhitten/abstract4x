namespace Space.Data.Space {
    ...
    public partial class AsteroidFiledTypesDAL : Space.Data.DataAccessBase {
        
        public AsteroidFiledTypesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private AsteroidFiledTypes Fill(System.Data.DataRow row) {
            AsteroidFiledTypes obj = new AsteroidFiledTypes();
        ...
        public virtual Collection<AsteroidFiledTypes> SelectObjects(AsteroidFiledTypes query) {
            Collection<AsteroidFiledTypes> objs = new Collection<AsteroidFiledTypes>();
...
while(e.MoveNext()) { 
 ...
 AsteroidFiledTypes obj = Fill(row);
 objs.Add(obj);
 }
            return objs;
        }
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledTypes");
        ...
        public virtual System.Data.DataSet Select(AsteroidFiledTypes query) {
            this.Access.CreateProcedureCommand("ssp_AsteroidFiledTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(AsteroidFiledTypes query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(AsteroidFiledTypes query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(AsteroidFiledTypes query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
