namespace Space.Data.Space {
    ...
    public partial class QubitsTypesDAL : Space.Data.DataAccessBase {
        
        public QubitsTypesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private QubitsTypes Fill(System.Data.DataRow row) {
            QubitsTypes obj = new QubitsTypes();
        ...
        public virtual Collection<QubitsTypes> SelectObjects(QubitsTypes query) {
            Collection<QubitsTypes> objs = new Collection<QubitsTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_QubitsTypes");
        ...
        public virtual System.Data.DataSet Select(QubitsTypes query) {
            this.Access.CreateProcedureCommand("ssp_QubitsTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(QubitsTypes query) {
            this.Access.CreateProcedureCommand("cp_QubitsTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(QubitsTypes query) {
            this.Access.CreateProcedureCommand("cp_QubitsTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(QubitsTypes query) {
            this.Access.CreateProcedureCommand("cp_QubitsTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
