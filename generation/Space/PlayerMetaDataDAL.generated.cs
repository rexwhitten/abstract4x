namespace Space.Data.Space {
    ...
    public partial class PlayerMetaDataDAL : Space.Data.DataAccessBase {
        
        public PlayerMetaDataDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private PlayerMetaData Fill(System.Data.DataRow row) {
            PlayerMetaData obj = new PlayerMetaData();
        ...
        public virtual Collection<PlayerMetaData> SelectObjects(PlayerMetaData query) {
            Collection<PlayerMetaData> objs = new Collection<PlayerMetaData>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_PlayerMetaData");
        ...
        public virtual System.Data.DataSet Select(PlayerMetaData query) {
            this.Access.CreateProcedureCommand("ssp_PlayerMetaData");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pPlayerSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_PlayerMetaData");
        ...
        // Updates a Record
        public virtual int Update(PlayerMetaData query) {
            this.Access.CreateProcedureCommand("cp_PlayerMetaData");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(PlayerMetaData query) {
            this.Access.CreateProcedureCommand("cp_PlayerMetaData");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pPlayerSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_PlayerMetaData");
        ...
        // Inserts a record
        public virtual int Insert(PlayerMetaData query) {
            this.Access.CreateProcedureCommand("cp_PlayerMetaData");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
