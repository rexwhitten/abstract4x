namespace Space.Data.Space {
    ...
    public partial class CharacterQubitsDAL : Space.Data.DataAccessBase {
        
        public CharacterQubitsDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private CharacterQubits Fill(System.Data.DataRow row) {
            CharacterQubits obj = new CharacterQubits();
        ...
        public virtual Collection<CharacterQubits> SelectObjects(CharacterQubits query) {
            Collection<CharacterQubits> objs = new Collection<CharacterQubits>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_CharacterQubits");
        ...
        public virtual System.Data.DataSet Select(CharacterQubits query) {
            this.Access.CreateProcedureCommand("ssp_CharacterQubits");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, string pPath, System.Nullable<int> pCharacterSysId, System.Nullable<int> pQubitsysId, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_CharacterQubits");
        ...
        // Updates a Record
        public virtual int Update(CharacterQubits query) {
            this.Access.CreateProcedureCommand("cp_CharacterQubits");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(CharacterQubits query) {
            this.Access.CreateProcedureCommand("cp_CharacterQubits");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, string pPath, System.Nullable<int> pCharacterSysId, System.Nullable<int> pQubitsysId, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_CharacterQubits");
        ...
        // Inserts a record
        public virtual int Insert(CharacterQubits query) {
            this.Access.CreateProcedureCommand("cp_CharacterQubits");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
