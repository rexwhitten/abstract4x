namespace Space.Data.Space {
    ...
    public partial class PlayersDAL : Space.Data.DataAccessBase {
        ...
        private Players Fill(System.Data.DataRow row) {
            Players obj = new Players();
            if ((row["SysId"] != System.DBNull.Value)) {
                obj.SysId = ((int?)(row["SysId"]));
            }
            if ((row["PlayerStatusSysId"] != System.DBNull.Value)) {
                obj.PlayerStatusSysId = ((int?)(row["PlayerStatusSysId"]));
            }
            if ((row["PlayerTypeSysId"] != System.DBNull.Value)) {
                obj.PlayerTypeSysId = ((int?)(row["PlayerTypeSysId"]));
            }
        ...
        public virtual Collection<Players> SelectObjects(Players query) {
            Collection<Players> objs = new Collection<Players>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_Players");
        ...
        public virtual System.Data.DataSet Select(Players query) {
            this.Access.CreateProcedureCommand("ssp_Players");
            if (query.SysId == null) {
            ...
            if (query.PlayerStatusSysId == null) {
                this.Access.AddParameter("PlayerStatusSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("PlayerStatusSysId",query.PlayerStatusSysId, ParameterDirection.Input);
            }
            if (query.PlayerTypeSysId == null) {
                this.Access.AddParameter("PlayerTypeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("PlayerTypeSysId",query.PlayerTypeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pPlayerStatusSysId, System.Nullable<int> pPlayerTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Players");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            this.Access.AddParameter("SysId", pSysId, ParameterDirection.Input);
            this.Access.AddParameter("PlayerStatusSysId", pPlayerStatusSysId, ParameterDirection.Input);
            this.Access.AddParameter("PlayerTypeSysId", pPlayerTypeSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(Players query) {
            this.Access.CreateProcedureCommand("cp_Players");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(Players query) {
            this.Access.CreateProcedureCommand("cp_Players");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pPlayerStatusSysId, System.Nullable<int> pPlayerTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Players");
        ...
        // Inserts a record
        public virtual int Insert(Players query) {
            this.Access.CreateProcedureCommand("cp_Players");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
