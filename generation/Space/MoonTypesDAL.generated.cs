namespace Space.Data.Space {
    ...
    public partial class MoonTypesDAL : Space.Data.DataAccessBase {
        ...
        private MoonTypes Fill(System.Data.DataRow row) {
            MoonTypes obj = new MoonTypes();
        ...
        public virtual Collection<MoonTypes> SelectObjects(MoonTypes query) {
            Collection<MoonTypes> objs = new Collection<MoonTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_MoonTypes");
        ...
        public virtual System.Data.DataSet Select(MoonTypes query) {
            this.Access.CreateProcedureCommand("ssp_MoonTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(MoonTypes query) {
            this.Access.CreateProcedureCommand("cp_MoonTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(MoonTypes query) {
            this.Access.CreateProcedureCommand("cp_MoonTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(MoonTypes query) {
            this.Access.CreateProcedureCommand("cp_MoonTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
