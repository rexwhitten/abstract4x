namespace Space.Data.Space {
    ...
    public partial class QubitssDAL : Space.Data.DataAccessBase {
        ...
        private Qubitss Fill(System.Data.DataRow row) {
            Qubitss obj = new Qubitss();
            if ((row["SysId"] != System.DBNull.Value)) {
                obj.SysId = ((int?)(row["SysId"]));
            }
            if ((row["QubitsStatusSysId"] != System.DBNull.Value)) {
                obj.QubitsStatusSysId = ((int?)(row["QubitsStatusSysId"]));
            }
            if ((row["QubitsTypeSysId"] != System.DBNull.Value)) {
                obj.QubitsTypeSysId = ((int?)(row["QubitsTypeSysId"]));
            }
        ...
        public virtual Collection<Qubitss> SelectObjects(Qubitss query) {
            Collection<Qubitss> objs = new Collection<Qubitss>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_Qubitss");
        ...
        public virtual System.Data.DataSet Select(Qubitss query) {
            this.Access.CreateProcedureCommand("ssp_Qubitss");
            if (query.SysId == null) {
            ...
            if (query.QubitsStatusSysId == null) {
                this.Access.AddParameter("QubitsStatusSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("QubitsStatusSysId",query.QubitsStatusSysId, ParameterDirection.Input);
            }
            if (query.QubitsTypeSysId == null) {
                this.Access.AddParameter("QubitsTypeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("QubitsTypeSysId",query.QubitsTypeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pQubitsStatusSysId, System.Nullable<int> pQubitsTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Qubitss");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            this.Access.AddParameter("SysId", pSysId, ParameterDirection.Input);
            this.Access.AddParameter("QubitsStatusSysId", pQubitsStatusSysId, ParameterDirection.Input);
            this.Access.AddParameter("QubitsTypeSysId", pQubitsTypeSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(Qubitss query) {
            this.Access.CreateProcedureCommand("cp_Qubitss");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(Qubitss query) {
            this.Access.CreateProcedureCommand("cp_Qubitss");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pQubitsStatusSysId, System.Nullable<int> pQubitsTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Qubitss");
        ...
        // Inserts a record
        public virtual int Insert(Qubitss query) {
            this.Access.CreateProcedureCommand("cp_Qubitss");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
