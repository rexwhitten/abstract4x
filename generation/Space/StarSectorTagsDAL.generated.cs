namespace Space.Data.Space {
    ...
    public partial class StarSectorTagsDAL : Space.Data.DataAccessBase {
        
        public StarSectorTagsDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private StarSectorTags Fill(System.Data.DataRow row) {
            StarSectorTags obj = new StarSectorTags();
        ...
        public virtual Collection<StarSectorTags> SelectObjects(StarSectorTags query) {
            Collection<StarSectorTags> objs = new Collection<StarSectorTags>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_StarSectorTags");
        ...
        public virtual System.Data.DataSet Select(StarSectorTags query) {
            this.Access.CreateProcedureCommand("ssp_StarSectorTags");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pStarSectorSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_StarSectorTags");
        ...
        // Updates a Record
        public virtual int Update(StarSectorTags query) {
            this.Access.CreateProcedureCommand("cp_StarSectorTags");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(StarSectorTags query) {
            this.Access.CreateProcedureCommand("cp_StarSectorTags");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pStarSectorSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_StarSectorTags");
        ...
        // Inserts a record
        public virtual int Insert(StarSectorTags query) {
            this.Access.CreateProcedureCommand("cp_StarSectorTags");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
