namespace Space.Data.Space {
    ...
    public partial class NebulaTypesDAL : Space.Data.DataAccessBase {
        
        public NebulaTypesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private NebulaTypes Fill(System.Data.DataRow row) {
            NebulaTypes obj = new NebulaTypes();
        ...
        public virtual Collection<NebulaTypes> SelectObjects(NebulaTypes query) {
            Collection<NebulaTypes> objs = new Collection<NebulaTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_NebulaTypes");
        ...
        public virtual System.Data.DataSet Select(NebulaTypes query) {
            this.Access.CreateProcedureCommand("ssp_NebulaTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(NebulaTypes query) {
            this.Access.CreateProcedureCommand("cp_NebulaTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(NebulaTypes query) {
            this.Access.CreateProcedureCommand("cp_NebulaTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(NebulaTypes query) {
            this.Access.CreateProcedureCommand("cp_NebulaTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
