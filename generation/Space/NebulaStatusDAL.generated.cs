namespace Space.Data.Space {
    ...
    public partial class NebulaStatusDAL : Space.Data.DataAccessBase {
        
        public NebulaStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private NebulaStatus Fill(System.Data.DataRow row) {
            NebulaStatus obj = new NebulaStatus();
        ...
        public virtual Collection<NebulaStatus> SelectObjects(NebulaStatus query) {
            Collection<NebulaStatus> objs = new Collection<NebulaStatus>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_NebulaStatus");
        ...
        public virtual System.Data.DataSet Select(NebulaStatus query) {
            this.Access.CreateProcedureCommand("ssp_NebulaStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(NebulaStatus query) {
            this.Access.CreateProcedureCommand("cp_NebulaStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(NebulaStatus query) {
            this.Access.CreateProcedureCommand("cp_NebulaStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(NebulaStatus query) {
            this.Access.CreateProcedureCommand("cp_NebulaStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
