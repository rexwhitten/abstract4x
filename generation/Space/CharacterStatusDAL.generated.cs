namespace Space.Data.Space {
    ...
    public partial class CharacterStatusDAL : Space.Data.DataAccessBase {
        
        public CharacterStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private CharacterStatus Fill(System.Data.DataRow row) {
            CharacterStatus obj = new CharacterStatus();
        ...
        public virtual Collection<CharacterStatus> SelectObjects(CharacterStatus query) {
            Collection<CharacterStatus> objs = new Collection<CharacterStatus>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_CharacterStatus");
        ...
        public virtual System.Data.DataSet Select(CharacterStatus query) {
            this.Access.CreateProcedureCommand("ssp_CharacterStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(CharacterStatus query) {
            this.Access.CreateProcedureCommand("cp_CharacterStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(CharacterStatus query) {
            this.Access.CreateProcedureCommand("cp_CharacterStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(CharacterStatus query) {
            this.Access.CreateProcedureCommand("cp_CharacterStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
