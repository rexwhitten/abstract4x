namespace Space.Data.Space {
    ...
    public partial class TechTreesDAL : Space.Data.DataAccessBase {
        ...
        private TechTrees Fill(System.Data.DataRow row) {
            TechTrees obj = new TechTrees();
            if ((row["SysId"] != System.DBNull.Value)) {
                obj.SysId = ((int?)(row["SysId"]));
            }
            if ((row["TechTreeStatusSysId"] != System.DBNull.Value)) {
                obj.TechTreeStatusSysId = ((int?)(row["TechTreeStatusSysId"]));
            }
            if ((row["TechTreeTypeSysId"] != System.DBNull.Value)) {
                obj.TechTreeTypeSysId = ((int?)(row["TechTreeTypeSysId"]));
            }
        ...
        public virtual Collection<TechTrees> SelectObjects(TechTrees query) {
            Collection<TechTrees> objs = new Collection<TechTrees>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_TechTrees");
        ...
        public virtual System.Data.DataSet Select(TechTrees query) {
            this.Access.CreateProcedureCommand("ssp_TechTrees");
            if (query.SysId == null) {
            ...
            if (query.TechTreeStatusSysId == null) {
                this.Access.AddParameter("TechTreeStatusSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("TechTreeStatusSysId",query.TechTreeStatusSysId, ParameterDirection.Input);
            }
            if (query.TechTreeTypeSysId == null) {
                this.Access.AddParameter("TechTreeTypeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("TechTreeTypeSysId",query.TechTreeTypeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pTechTreeStatusSysId, System.Nullable<int> pTechTreeTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_TechTrees");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            this.Access.AddParameter("SysId", pSysId, ParameterDirection.Input);
            this.Access.AddParameter("TechTreeStatusSysId", pTechTreeStatusSysId, ParameterDirection.Input);
            this.Access.AddParameter("TechTreeTypeSysId", pTechTreeTypeSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(TechTrees query) {
            this.Access.CreateProcedureCommand("cp_TechTrees");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(TechTrees query) {
            this.Access.CreateProcedureCommand("cp_TechTrees");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pTechTreeStatusSysId, System.Nullable<int> pTechTreeTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_TechTrees");
        ...
        // Inserts a record
        public virtual int Insert(TechTrees query) {
            this.Access.CreateProcedureCommand("cp_TechTrees");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
