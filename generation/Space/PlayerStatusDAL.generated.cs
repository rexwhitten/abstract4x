namespace Space.Data.Space {
    ...
    public partial class PlayerStatusDAL : Space.Data.DataAccessBase {
        
        public PlayerStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private PlayerStatus Fill(System.Data.DataRow row) {
            PlayerStatus obj = new PlayerStatus();
        ...
        public virtual Collection<PlayerStatus> SelectObjects(PlayerStatus query) {
            Collection<PlayerStatus> objs = new Collection<PlayerStatus>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_PlayerStatus");
        ...
        public virtual System.Data.DataSet Select(PlayerStatus query) {
            this.Access.CreateProcedureCommand("ssp_PlayerStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(PlayerStatus query) {
            this.Access.CreateProcedureCommand("cp_PlayerStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(PlayerStatus query) {
            this.Access.CreateProcedureCommand("cp_PlayerStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(PlayerStatus query) {
            this.Access.CreateProcedureCommand("cp_PlayerStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
