namespace Space.Data.Space {
    ...
    public partial class ActorsDAL : Space.Data.DataAccessBase {
        ...
        private Actors Fill(System.Data.DataRow row) {
            Actors obj = new Actors();
            if ((row["SysId"] != System.DBNull.Value)) {
                obj.SysId = ((int?)(row["SysId"]));
            }
            if ((row["ActorStatusSysId"] != System.DBNull.Value)) {
                obj.ActorStatusSysId = ((int?)(row["ActorStatusSysId"]));
            }
            if ((row["ActorTypeSysId"] != System.DBNull.Value)) {
                obj.ActorTypeSysId = ((int?)(row["ActorTypeSysId"]));
            }
        ...
        public virtual Collection<Actors> SelectObjects(Actors query) {
            Collection<Actors> objs = new Collection<Actors>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_Actors");
        ...
        public virtual System.Data.DataSet Select(Actors query) {
            this.Access.CreateProcedureCommand("ssp_Actors");
            if (query.SysId == null) {
            ...
            if (query.ActorStatusSysId == null) {
                this.Access.AddParameter("ActorStatusSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ActorStatusSysId",query.ActorStatusSysId, ParameterDirection.Input);
            }
            if (query.ActorTypeSysId == null) {
                this.Access.AddParameter("ActorTypeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ActorTypeSysId",query.ActorTypeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pActorStatusSysId, System.Nullable<int> pActorTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Actors");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            this.Access.AddParameter("SysId", pSysId, ParameterDirection.Input);
            this.Access.AddParameter("ActorStatusSysId", pActorStatusSysId, ParameterDirection.Input);
            this.Access.AddParameter("ActorTypeSysId", pActorTypeSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(Actors query) {
            this.Access.CreateProcedureCommand("cp_Actors");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(Actors query) {
            this.Access.CreateProcedureCommand("cp_Actors");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pActorStatusSysId, System.Nullable<int> pActorTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Actors");
        ...
        // Inserts a record
        public virtual int Insert(Actors query) {
            this.Access.CreateProcedureCommand("cp_Actors");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
