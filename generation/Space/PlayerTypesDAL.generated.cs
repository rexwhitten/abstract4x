namespace Space.Data.Space {
    ...
    public partial class PlayerTypesDAL : Space.Data.DataAccessBase {
        
        public PlayerTypesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private PlayerTypes Fill(System.Data.DataRow row) {
            PlayerTypes obj = new PlayerTypes();
        ...
        public virtual Collection<PlayerTypes> SelectObjects(PlayerTypes query) {
            Collection<PlayerTypes> objs = new Collection<PlayerTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_PlayerTypes");
        ...
        public virtual System.Data.DataSet Select(PlayerTypes query) {
            this.Access.CreateProcedureCommand("ssp_PlayerTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(PlayerTypes query) {
            this.Access.CreateProcedureCommand("cp_PlayerTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(PlayerTypes query) {
            this.Access.CreateProcedureCommand("cp_PlayerTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(PlayerTypes query) {
            this.Access.CreateProcedureCommand("cp_PlayerTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
