namespace Space.Data.Space {
    ...
    public partial class MoonStatusDAL : Space.Data.DataAccessBase {
        
        public MoonStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private MoonStatus Fill(System.Data.DataRow row) {
            MoonStatus obj = new MoonStatus();
        ...
        public virtual Collection<MoonStatus> SelectObjects(MoonStatus query) {
            Collection<MoonStatus> objs = new Collection<MoonStatus>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_MoonStatus");
        ...
        public virtual System.Data.DataSet Select(MoonStatus query) {
            this.Access.CreateProcedureCommand("ssp_MoonStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(MoonStatus query) {
            this.Access.CreateProcedureCommand("cp_MoonStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(MoonStatus query) {
            this.Access.CreateProcedureCommand("cp_MoonStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(MoonStatus query) {
            this.Access.CreateProcedureCommand("cp_MoonStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
