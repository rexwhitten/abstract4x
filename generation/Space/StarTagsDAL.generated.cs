namespace Space.Data.Space {
    ...
    public partial class StarTagsDAL : Space.Data.DataAccessBase {
        ...
        private StarTags Fill(System.Data.DataRow row) {
            StarTags obj = new StarTags();
        ...
        public virtual Collection<StarTags> SelectObjects(StarTags query) {
            Collection<StarTags> objs = new Collection<StarTags>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_StarTags");
        ...
        public virtual System.Data.DataSet Select(StarTags query) {
            this.Access.CreateProcedureCommand("ssp_StarTags");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pStarSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_StarTags");
        ...
        // Updates a Record
        public virtual int Update(StarTags query) {
            this.Access.CreateProcedureCommand("cp_StarTags");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(StarTags query) {
            this.Access.CreateProcedureCommand("cp_StarTags");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pStarSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_StarTags");
        ...
        // Inserts a record
        public virtual int Insert(StarTags query) {
            this.Access.CreateProcedureCommand("cp_StarTags");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
