namespace Space.Data.Space {
    ...
    public partial class GalaxyTypesDAL : Space.Data.DataAccessBase {
        
        public GalaxyTypesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private GalaxyTypes Fill(System.Data.DataRow row) {
            GalaxyTypes obj = new GalaxyTypes();
        ...
        public virtual Collection<GalaxyTypes> SelectObjects(GalaxyTypes query) {
            Collection<GalaxyTypes> objs = new Collection<GalaxyTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_GalaxyTypes");
        ...
        public virtual System.Data.DataSet Select(GalaxyTypes query) {
            this.Access.CreateProcedureCommand("ssp_GalaxyTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(GalaxyTypes query) {
            this.Access.CreateProcedureCommand("cp_GalaxyTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(GalaxyTypes query) {
            this.Access.CreateProcedureCommand("cp_GalaxyTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(GalaxyTypes query) {
            this.Access.CreateProcedureCommand("cp_GalaxyTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
