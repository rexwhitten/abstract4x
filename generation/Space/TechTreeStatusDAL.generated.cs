namespace Space.Data.Space {
    ...
    public partial class TechTreeStatusDAL : Space.Data.DataAccessBase {
        
        public TechTreeStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private TechTreeStatus Fill(System.Data.DataRow row) {
            TechTreeStatus obj = new TechTreeStatus();
        ...
        public virtual Collection<TechTreeStatus> SelectObjects(TechTreeStatus query) {
            Collection<TechTreeStatus> objs = new Collection<TechTreeStatus>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_TechTreeStatus");
        ...
        public virtual System.Data.DataSet Select(TechTreeStatus query) {
            this.Access.CreateProcedureCommand("ssp_TechTreeStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(TechTreeStatus query) {
            this.Access.CreateProcedureCommand("cp_TechTreeStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(TechTreeStatus query) {
            this.Access.CreateProcedureCommand("cp_TechTreeStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(TechTreeStatus query) {
            this.Access.CreateProcedureCommand("cp_TechTreeStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
