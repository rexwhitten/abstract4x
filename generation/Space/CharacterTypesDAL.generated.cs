namespace Space.Data.Space {
    ...
    public partial class CharacterTypesDAL : Space.Data.DataAccessBase {
        
        public CharacterTypesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private CharacterTypes Fill(System.Data.DataRow row) {
            CharacterTypes obj = new CharacterTypes();
        ...
        public virtual Collection<CharacterTypes> SelectObjects(CharacterTypes query) {
            Collection<CharacterTypes> objs = new Collection<CharacterTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_CharacterTypes");
        ...
        public virtual System.Data.DataSet Select(CharacterTypes query) {
            this.Access.CreateProcedureCommand("ssp_CharacterTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(CharacterTypes query) {
            this.Access.CreateProcedureCommand("cp_CharacterTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(CharacterTypes query) {
            this.Access.CreateProcedureCommand("cp_CharacterTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(CharacterTypes query) {
            this.Access.CreateProcedureCommand("cp_CharacterTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
