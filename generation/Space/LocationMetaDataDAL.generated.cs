namespace Space.Data.Space {
    ...
    public partial class LocationMetaDataDAL : Space.Data.DataAccessBase {
        
        public LocationMetaDataDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private LocationMetaData Fill(System.Data.DataRow row) {
            LocationMetaData obj = new LocationMetaData();
            ...
            if ((row["LocationSysId"] != System.DBNull.Value)) {
                obj.LocationSysId = ((int?)(row["LocationSysId"]));
            }
        ...
        public virtual Collection<LocationMetaData> SelectObjects(LocationMetaData query) {
            Collection<LocationMetaData> objs = new Collection<LocationMetaData>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_LocationMetaData");
        ...
        public virtual System.Data.DataSet Select(LocationMetaData query) {
            this.Access.CreateProcedureCommand("ssp_LocationMetaData");
            if (query.SysId == null) {
            ...
            if (query.LocationSysId == null) {
                this.Access.AddParameter("LocationSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("LocationSysId",query.LocationSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pLocationSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_LocationMetaData");
            ...
            this.Access.AddParameter("LocationSysId", pLocationSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(LocationMetaData query) {
            this.Access.CreateProcedureCommand("cp_LocationMetaData");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(LocationMetaData query) {
            this.Access.CreateProcedureCommand("cp_LocationMetaData");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pLocationSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_LocationMetaData");
        ...
        // Inserts a record
        public virtual int Insert(LocationMetaData query) {
            this.Access.CreateProcedureCommand("cp_LocationMetaData");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
