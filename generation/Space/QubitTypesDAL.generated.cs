namespace Space.Data.Space {
    ...
    public partial class QubitTypesDAL : Space.Data.DataAccessBase {
        
        public QubitTypesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private QubitTypes Fill(System.Data.DataRow row) {
            QubitTypes obj = new QubitTypes();
        ...
        public virtual Collection<QubitTypes> SelectObjects(QubitTypes query) {
            Collection<QubitTypes> objs = new Collection<QubitTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_QubitTypes");
        ...
        public virtual System.Data.DataSet Select(QubitTypes query) {
            this.Access.CreateProcedureCommand("ssp_QubitTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(QubitTypes query) {
            this.Access.CreateProcedureCommand("cp_QubitTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(QubitTypes query) {
            this.Access.CreateProcedureCommand("cp_QubitTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(QubitTypes query) {
            this.Access.CreateProcedureCommand("cp_QubitTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
