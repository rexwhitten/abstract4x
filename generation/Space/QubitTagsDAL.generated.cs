namespace Space.Data.Space {
    ...
    public partial class QubitTagsDAL : Space.Data.DataAccessBase {
        ...
        private QubitTags Fill(System.Data.DataRow row) {
            QubitTags obj = new QubitTags();
        ...
        public virtual Collection<QubitTags> SelectObjects(QubitTags query) {
            Collection<QubitTags> objs = new Collection<QubitTags>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_QubitTags");
        ...
        public virtual System.Data.DataSet Select(QubitTags query) {
            this.Access.CreateProcedureCommand("ssp_QubitTags");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pQubitSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_QubitTags");
        ...
        // Updates a Record
        public virtual int Update(QubitTags query) {
            this.Access.CreateProcedureCommand("cp_QubitTags");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(QubitTags query) {
            this.Access.CreateProcedureCommand("cp_QubitTags");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pQubitSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_QubitTags");
        ...
        // Inserts a record
        public virtual int Insert(QubitTags query) {
            this.Access.CreateProcedureCommand("cp_QubitTags");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
