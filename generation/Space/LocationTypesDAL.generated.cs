namespace Space.Data.Space {
    ...
    public partial class LocationTypesDAL : Space.Data.DataAccessBase {
        
        public LocationTypesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private LocationTypes Fill(System.Data.DataRow row) {
            LocationTypes obj = new LocationTypes();
        ...
        public virtual Collection<LocationTypes> SelectObjects(LocationTypes query) {
            Collection<LocationTypes> objs = new Collection<LocationTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_LocationTypes");
        ...
        public virtual System.Data.DataSet Select(LocationTypes query) {
            this.Access.CreateProcedureCommand("ssp_LocationTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(LocationTypes query) {
            this.Access.CreateProcedureCommand("cp_LocationTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(LocationTypes query) {
            this.Access.CreateProcedureCommand("cp_LocationTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(LocationTypes query) {
            this.Access.CreateProcedureCommand("cp_LocationTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
