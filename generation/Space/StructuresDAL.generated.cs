namespace Space.Data.Space {
    ...
    public partial class StructuresDAL : Space.Data.DataAccessBase {
        ...
        private Structures Fill(System.Data.DataRow row) {
            Structures obj = new Structures();
            if ((row["SysId"] != System.DBNull.Value)) {
                obj.SysId = ((int?)(row["SysId"]));
            }
            if ((row["StructureStatusSysId"] != System.DBNull.Value)) {
                obj.StructureStatusSysId = ((int?)(row["StructureStatusSysId"]));
            }
            if ((row["StructureTypeSysId"] != System.DBNull.Value)) {
                obj.StructureTypeSysId = ((int?)(row["StructureTypeSysId"]));
            }
        ...
        public virtual Collection<Structures> SelectObjects(Structures query) {
            Collection<Structures> objs = new Collection<Structures>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_Structures");
        ...
        public virtual System.Data.DataSet Select(Structures query) {
            this.Access.CreateProcedureCommand("ssp_Structures");
            if (query.SysId == null) {
            ...
            if (query.StructureStatusSysId == null) {
                this.Access.AddParameter("StructureStatusSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("StructureStatusSysId",query.StructureStatusSysId, ParameterDirection.Input);
            }
            if (query.StructureTypeSysId == null) {
                this.Access.AddParameter("StructureTypeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("StructureTypeSysId",query.StructureTypeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pStructureStatusSysId, System.Nullable<int> pStructureTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Structures");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            this.Access.AddParameter("SysId", pSysId, ParameterDirection.Input);
            this.Access.AddParameter("StructureStatusSysId", pStructureStatusSysId, ParameterDirection.Input);
            this.Access.AddParameter("StructureTypeSysId", pStructureTypeSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(Structures query) {
            this.Access.CreateProcedureCommand("cp_Structures");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(Structures query) {
            this.Access.CreateProcedureCommand("cp_Structures");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pStructureStatusSysId, System.Nullable<int> pStructureTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Structures");
        ...
        // Inserts a record
        public virtual int Insert(Structures query) {
            this.Access.CreateProcedureCommand("cp_Structures");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
