namespace Space.Data.Space {
    ...
    public partial class MoonMetaDataDAL : Space.Data.DataAccessBase {
        
        public MoonMetaDataDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private MoonMetaData Fill(System.Data.DataRow row) {
            MoonMetaData obj = new MoonMetaData();
        ...
        public virtual Collection<MoonMetaData> SelectObjects(MoonMetaData query) {
            Collection<MoonMetaData> objs = new Collection<MoonMetaData>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_MoonMetaData");
        ...
        public virtual System.Data.DataSet Select(MoonMetaData query) {
            this.Access.CreateProcedureCommand("ssp_MoonMetaData");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pMoonSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_MoonMetaData");
        ...
        // Updates a Record
        public virtual int Update(MoonMetaData query) {
            this.Access.CreateProcedureCommand("cp_MoonMetaData");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(MoonMetaData query) {
            this.Access.CreateProcedureCommand("cp_MoonMetaData");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pMoonSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_MoonMetaData");
        ...
        // Inserts a record
        public virtual int Insert(MoonMetaData query) {
            this.Access.CreateProcedureCommand("cp_MoonMetaData");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
