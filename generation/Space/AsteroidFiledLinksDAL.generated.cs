namespace Space.Data.Space {
    ...
    public partial class AsteroidFiledLinksDAL : Space.Data.DataAccessBase {
        
        public AsteroidFiledLinksDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private AsteroidFiledLinks Fill(System.Data.DataRow row) {
            AsteroidFiledLinks obj = new AsteroidFiledLinks();
            ...
            if ((row["ParentAsteroidFiledSysId"] != System.DBNull.Value)) {
                obj.ParentAsteroidFiledSysId = ((int?)(row["ParentAsteroidFiledSysId"]));
            }
            if ((row["ChildAsteroidFiledSysId"] != System.DBNull.Value)) {
                obj.ChildAsteroidFiledSysId = ((int?)(row["ChildAsteroidFiledSysId"]));
            }
        ...
        public virtual Collection<AsteroidFiledLinks> SelectObjects(AsteroidFiledLinks query) {
            Collection<AsteroidFiledLinks> objs = new Collection<AsteroidFiledLinks>();
...
while(e.MoveNext()) { 
 ...
 AsteroidFiledLinks obj = Fill(row);
 objs.Add(obj);
 }
            return objs;
        }
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledLinks");
        ...
        public virtual System.Data.DataSet Select(AsteroidFiledLinks query) {
            this.Access.CreateProcedureCommand("ssp_AsteroidFiledLinks");
            if (query.SysId == null) {
            ...
            if (query.ParentAsteroidFiledSysId == null) {
                this.Access.AddParameter("ParentAsteroidFiledSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ParentAsteroidFiledSysId",query.ParentAsteroidFiledSysId, ParameterDirection.Input);
            }
            if (query.ChildAsteroidFiledSysId == null) {
                this.Access.AddParameter("ChildAsteroidFiledSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ChildAsteroidFiledSysId",query.ChildAsteroidFiledSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentAsteroidFiledSysId, System.Nullable<int> pChildAsteroidFiledSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledLinks");
            ...
            this.Access.AddParameter("ParentAsteroidFiledSysId", pParentAsteroidFiledSysId, ParameterDirection.Input);
            this.Access.AddParameter("ChildAsteroidFiledSysId", pChildAsteroidFiledSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(AsteroidFiledLinks query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledLinks");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(AsteroidFiledLinks query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledLinks");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentAsteroidFiledSysId, System.Nullable<int> pChildAsteroidFiledSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledLinks");
        ...
        // Inserts a record
        public virtual int Insert(AsteroidFiledLinks query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledLinks");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
