namespace Space.Data.Space {
    ...
    public partial class PlanetTypesDAL : Space.Data.DataAccessBase {
        
        public PlanetTypesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private PlanetTypes Fill(System.Data.DataRow row) {
            PlanetTypes obj = new PlanetTypes();
        ...
        public virtual Collection<PlanetTypes> SelectObjects(PlanetTypes query) {
            Collection<PlanetTypes> objs = new Collection<PlanetTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_PlanetTypes");
        ...
        public virtual System.Data.DataSet Select(PlanetTypes query) {
            this.Access.CreateProcedureCommand("ssp_PlanetTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(PlanetTypes query) {
            this.Access.CreateProcedureCommand("cp_PlanetTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(PlanetTypes query) {
            this.Access.CreateProcedureCommand("cp_PlanetTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(PlanetTypes query) {
            this.Access.CreateProcedureCommand("cp_PlanetTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
