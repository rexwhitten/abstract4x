namespace Space.Data.Space {
    ...
    public partial class NebulaTagsDAL : Space.Data.DataAccessBase {
        
        public NebulaTagsDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private NebulaTags Fill(System.Data.DataRow row) {
            NebulaTags obj = new NebulaTags();
        ...
        public virtual Collection<NebulaTags> SelectObjects(NebulaTags query) {
            Collection<NebulaTags> objs = new Collection<NebulaTags>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_NebulaTags");
        ...
        public virtual System.Data.DataSet Select(NebulaTags query) {
            this.Access.CreateProcedureCommand("ssp_NebulaTags");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pNebulaSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_NebulaTags");
        ...
        // Updates a Record
        public virtual int Update(NebulaTags query) {
            this.Access.CreateProcedureCommand("cp_NebulaTags");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(NebulaTags query) {
            this.Access.CreateProcedureCommand("cp_NebulaTags");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pNebulaSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_NebulaTags");
        ...
        // Inserts a record
        public virtual int Insert(NebulaTags query) {
            this.Access.CreateProcedureCommand("cp_NebulaTags");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
