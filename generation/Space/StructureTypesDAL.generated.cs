namespace Space.Data.Space {
    ...
    public partial class StructureTypesDAL : Space.Data.DataAccessBase {
        
        public StructureTypesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private StructureTypes Fill(System.Data.DataRow row) {
            StructureTypes obj = new StructureTypes();
        ...
        public virtual Collection<StructureTypes> SelectObjects(StructureTypes query) {
            Collection<StructureTypes> objs = new Collection<StructureTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_StructureTypes");
        ...
        public virtual System.Data.DataSet Select(StructureTypes query) {
            this.Access.CreateProcedureCommand("ssp_StructureTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(StructureTypes query) {
            this.Access.CreateProcedureCommand("cp_StructureTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(StructureTypes query) {
            this.Access.CreateProcedureCommand("cp_StructureTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(StructureTypes query) {
            this.Access.CreateProcedureCommand("cp_StructureTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
