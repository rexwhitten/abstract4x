namespace Space.Data.Space {
    ...
    public partial class GalaxyStatusDAL : Space.Data.DataAccessBase {
        
        public GalaxyStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private GalaxyStatus Fill(System.Data.DataRow row) {
            GalaxyStatus obj = new GalaxyStatus();
        ...
        public virtual Collection<GalaxyStatus> SelectObjects(GalaxyStatus query) {
            Collection<GalaxyStatus> objs = new Collection<GalaxyStatus>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_GalaxyStatus");
        ...
        public virtual System.Data.DataSet Select(GalaxyStatus query) {
            this.Access.CreateProcedureCommand("ssp_GalaxyStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(GalaxyStatus query) {
            this.Access.CreateProcedureCommand("cp_GalaxyStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(GalaxyStatus query) {
            this.Access.CreateProcedureCommand("cp_GalaxyStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(GalaxyStatus query) {
            this.Access.CreateProcedureCommand("cp_GalaxyStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
