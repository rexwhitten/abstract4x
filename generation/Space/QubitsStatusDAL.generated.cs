namespace Space.Data.Space {
    ...
    public partial class QubitsStatusDAL : Space.Data.DataAccessBase {
        
        public QubitsStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private QubitsStatus Fill(System.Data.DataRow row) {
            QubitsStatus obj = new QubitsStatus();
        ...
        public virtual Collection<QubitsStatus> SelectObjects(QubitsStatus query) {
            Collection<QubitsStatus> objs = new Collection<QubitsStatus>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_QubitsStatus");
        ...
        public virtual System.Data.DataSet Select(QubitsStatus query) {
            this.Access.CreateProcedureCommand("ssp_QubitsStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(QubitsStatus query) {
            this.Access.CreateProcedureCommand("cp_QubitsStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(QubitsStatus query) {
            this.Access.CreateProcedureCommand("cp_QubitsStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(QubitsStatus query) {
            this.Access.CreateProcedureCommand("cp_QubitsStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
