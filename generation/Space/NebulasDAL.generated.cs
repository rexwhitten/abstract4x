namespace Space.Data.Space {
    ...
    public partial class NebulasDAL : Space.Data.DataAccessBase {
        ...
        private Nebulas Fill(System.Data.DataRow row) {
            Nebulas obj = new Nebulas();
            if ((row["SysId"] != System.DBNull.Value)) {
                obj.SysId = ((int?)(row["SysId"]));
            }
            if ((row["NebulaStatusSysId"] != System.DBNull.Value)) {
                obj.NebulaStatusSysId = ((int?)(row["NebulaStatusSysId"]));
            }
            if ((row["NebulaTypeSysId"] != System.DBNull.Value)) {
                obj.NebulaTypeSysId = ((int?)(row["NebulaTypeSysId"]));
            }
        ...
        public virtual Collection<Nebulas> SelectObjects(Nebulas query) {
            Collection<Nebulas> objs = new Collection<Nebulas>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_Nebulas");
        ...
        public virtual System.Data.DataSet Select(Nebulas query) {
            this.Access.CreateProcedureCommand("ssp_Nebulas");
            if (query.SysId == null) {
            ...
            if (query.NebulaStatusSysId == null) {
                this.Access.AddParameter("NebulaStatusSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("NebulaStatusSysId",query.NebulaStatusSysId, ParameterDirection.Input);
            }
            if (query.NebulaTypeSysId == null) {
                this.Access.AddParameter("NebulaTypeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("NebulaTypeSysId",query.NebulaTypeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(Nebulas query) {
            this.Access.CreateProcedureCommand("cp_Nebulas");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(Nebulas query) {
            this.Access.CreateProcedureCommand("cp_Nebulas");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pNebulaStatusSysId, System.Nullable<int> pNebulaTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Nebulas");
        ...
        // Inserts a record
        public virtual int Insert(Nebulas query) {
            this.Access.CreateProcedureCommand("cp_Nebulas");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
