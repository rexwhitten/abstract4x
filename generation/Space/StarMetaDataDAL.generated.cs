namespace Space.Data.Space {
    ...
    public partial class StarMetaDataDAL : Space.Data.DataAccessBase {
        
        public StarMetaDataDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private StarMetaData Fill(System.Data.DataRow row) {
            StarMetaData obj = new StarMetaData();
            ...
            if ((row["StarSysId"] != System.DBNull.Value)) {
                obj.StarSysId = ((int?)(row["StarSysId"]));
            }
        ...
        public virtual Collection<StarMetaData> SelectObjects(StarMetaData query) {
            Collection<StarMetaData> objs = new Collection<StarMetaData>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_StarMetaData");
        ...
        public virtual System.Data.DataSet Select(StarMetaData query) {
            this.Access.CreateProcedureCommand("ssp_StarMetaData");
            if (query.SysId == null) {
            ...
            if (query.StarSysId == null) {
                this.Access.AddParameter("StarSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("StarSysId",query.StarSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pStarSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_StarMetaData");
            ...
            this.Access.AddParameter("StarSysId", pStarSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(StarMetaData query) {
            this.Access.CreateProcedureCommand("cp_StarMetaData");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(StarMetaData query) {
            this.Access.CreateProcedureCommand("cp_StarMetaData");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pStarSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_StarMetaData");
        ...
        // Inserts a record
        public virtual int Insert(StarMetaData query) {
            this.Access.CreateProcedureCommand("cp_StarMetaData");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
