namespace Space.Data.Space {
    ...
    public partial class StructureLinksDAL : Space.Data.DataAccessBase {
        
        public StructureLinksDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private StructureLinks Fill(System.Data.DataRow row) {
            StructureLinks obj = new StructureLinks();
            ...
            if ((row["ParentStructureSysId"] != System.DBNull.Value)) {
                obj.ParentStructureSysId = ((int?)(row["ParentStructureSysId"]));
            }
            if ((row["ChildStructureSysId"] != System.DBNull.Value)) {
                obj.ChildStructureSysId = ((int?)(row["ChildStructureSysId"]));
            }
        ...
        public virtual Collection<StructureLinks> SelectObjects(StructureLinks query) {
            Collection<StructureLinks> objs = new Collection<StructureLinks>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_StructureLinks");
        ...
        public virtual System.Data.DataSet Select(StructureLinks query) {
            this.Access.CreateProcedureCommand("ssp_StructureLinks");
            if (query.SysId == null) {
            ...
            if (query.ParentStructureSysId == null) {
                this.Access.AddParameter("ParentStructureSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ParentStructureSysId",query.ParentStructureSysId, ParameterDirection.Input);
            }
            if (query.ChildStructureSysId == null) {
                this.Access.AddParameter("ChildStructureSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ChildStructureSysId",query.ChildStructureSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentStructureSysId, System.Nullable<int> pChildStructureSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_StructureLinks");
            ...
            this.Access.AddParameter("ParentStructureSysId", pParentStructureSysId, ParameterDirection.Input);
            this.Access.AddParameter("ChildStructureSysId", pChildStructureSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(StructureLinks query) {
            this.Access.CreateProcedureCommand("cp_StructureLinks");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(StructureLinks query) {
            this.Access.CreateProcedureCommand("cp_StructureLinks");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentStructureSysId, System.Nullable<int> pChildStructureSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_StructureLinks");
        ...
        // Inserts a record
        public virtual int Insert(StructureLinks query) {
            this.Access.CreateProcedureCommand("cp_StructureLinks");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
