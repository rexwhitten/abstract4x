namespace Space.Data.Space {
    ...
    public partial class StructureStatusDAL : Space.Data.DataAccessBase {
        
        public StructureStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private StructureStatus Fill(System.Data.DataRow row) {
            StructureStatus obj = new StructureStatus();
        ...
        public virtual Collection<StructureStatus> SelectObjects(StructureStatus query) {
            Collection<StructureStatus> objs = new Collection<StructureStatus>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_StructureStatus");
        ...
        public virtual System.Data.DataSet Select(StructureStatus query) {
            this.Access.CreateProcedureCommand("ssp_StructureStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(StructureStatus query) {
            this.Access.CreateProcedureCommand("cp_StructureStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(StructureStatus query) {
            this.Access.CreateProcedureCommand("cp_StructureStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(StructureStatus query) {
            this.Access.CreateProcedureCommand("cp_StructureStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
