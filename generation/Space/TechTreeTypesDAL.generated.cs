namespace Space.Data.Space {
    ...
    public partial class TechTreeTypesDAL : Space.Data.DataAccessBase {
        
        public TechTreeTypesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private TechTreeTypes Fill(System.Data.DataRow row) {
            TechTreeTypes obj = new TechTreeTypes();
        ...
        public virtual Collection<TechTreeTypes> SelectObjects(TechTreeTypes query) {
            Collection<TechTreeTypes> objs = new Collection<TechTreeTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_TechTreeTypes");
        ...
        public virtual System.Data.DataSet Select(TechTreeTypes query) {
            this.Access.CreateProcedureCommand("ssp_TechTreeTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(TechTreeTypes query) {
            this.Access.CreateProcedureCommand("cp_TechTreeTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(TechTreeTypes query) {
            this.Access.CreateProcedureCommand("cp_TechTreeTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(TechTreeTypes query) {
            this.Access.CreateProcedureCommand("cp_TechTreeTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
