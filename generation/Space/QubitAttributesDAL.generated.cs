namespace Space.Data.Space {
    ...
    public partial class QubitAttributesDAL : Space.Data.DataAccessBase {
        
        public QubitAttributesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private QubitAttributes Fill(System.Data.DataRow row) {
            QubitAttributes obj = new QubitAttributes();
            ...
            if ((row["Amount"] != System.DBNull.Value)) {
                obj.Amount = ((int?)(row["Amount"]));
            }
            return obj;
        }
        
        // Returns an IEnumerable of Hydrated POCO's
        public virtual Collection<QubitAttributes> SelectObjects(QubitAttributes query) {
            Collection<QubitAttributes> objs = new Collection<QubitAttributes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_QubitAttributes");
        ...
        public virtual System.Data.DataSet Select(QubitAttributes query) {
            this.Access.CreateProcedureCommand("ssp_QubitAttributes");
            if (query.SysId == null) {
            ...
            if (query.Amount == null) {
                this.Access.AddParameter("Amount", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("Amount",query.Amount, ParameterDirection.Input);
            }
            return this.Access.ExecuteDataSet();
        }
        
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pQubitSysId, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<int> pAmount) {
            this.Access.CreateProcedureCommand("cp_QubitAttributes");
            ...
            this.Access.AddParameter("Amount", pAmount, ParameterDirection.Input);
            var value  = this.Access.ExecuteNonQuery();
            return value;
        }
        
        // Updates a Record
        public virtual int Update(QubitAttributes query) {
            this.Access.CreateProcedureCommand("cp_QubitAttributes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(QubitAttributes query) {
            this.Access.CreateProcedureCommand("cp_QubitAttributes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pQubitSysId, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<int> pAmount) {
            this.Access.CreateProcedureCommand("cp_QubitAttributes");
        ...
        // Inserts a record
        public virtual int Insert(QubitAttributes query) {
            this.Access.CreateProcedureCommand("cp_QubitAttributes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
