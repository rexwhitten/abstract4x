namespace Space.Data.Space {
    ...
    public partial class ActorTypesDAL : Space.Data.DataAccessBase {
        
        public ActorTypesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private ActorTypes Fill(System.Data.DataRow row) {
            ActorTypes obj = new ActorTypes();
        ...
        public virtual Collection<ActorTypes> SelectObjects(ActorTypes query) {
            Collection<ActorTypes> objs = new Collection<ActorTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_ActorTypes");
        ...
        public virtual System.Data.DataSet Select(ActorTypes query) {
            this.Access.CreateProcedureCommand("ssp_ActorTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(ActorTypes query) {
            this.Access.CreateProcedureCommand("cp_ActorTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(ActorTypes query) {
            this.Access.CreateProcedureCommand("cp_ActorTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(ActorTypes query) {
            this.Access.CreateProcedureCommand("cp_ActorTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
