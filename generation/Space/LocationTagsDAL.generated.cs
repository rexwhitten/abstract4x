namespace Space.Data.Space {
    ...
    public partial class LocationTagsDAL : Space.Data.DataAccessBase {
        
        public LocationTagsDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private LocationTags Fill(System.Data.DataRow row) {
            LocationTags obj = new LocationTags();
        ...
        public virtual Collection<LocationTags> SelectObjects(LocationTags query) {
            Collection<LocationTags> objs = new Collection<LocationTags>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_LocationTags");
        ...
        public virtual System.Data.DataSet Select(LocationTags query) {
            this.Access.CreateProcedureCommand("ssp_LocationTags");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pLocationSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_LocationTags");
        ...
        // Updates a Record
        public virtual int Update(LocationTags query) {
            this.Access.CreateProcedureCommand("cp_LocationTags");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(LocationTags query) {
            this.Access.CreateProcedureCommand("cp_LocationTags");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pLocationSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_LocationTags");
        ...
        // Inserts a record
        public virtual int Insert(LocationTags query) {
            this.Access.CreateProcedureCommand("cp_LocationTags");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
