namespace Space.Data.Space {
    ...
    public partial class CharactersDAL : Space.Data.DataAccessBase {
        ...
        private Characters Fill(System.Data.DataRow row) {
            Characters obj = new Characters();
            if ((row["SysId"] != System.DBNull.Value)) {
                obj.SysId = ((int?)(row["SysId"]));
            }
            if ((row["CharacterStatusSysId"] != System.DBNull.Value)) {
                obj.CharacterStatusSysId = ((int?)(row["CharacterStatusSysId"]));
            }
            if ((row["CharacterTypeSysId"] != System.DBNull.Value)) {
                obj.CharacterTypeSysId = ((int?)(row["CharacterTypeSysId"]));
            }
        ...
        public virtual Collection<Characters> SelectObjects(Characters query) {
            Collection<Characters> objs = new Collection<Characters>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_Characters");
        ...
        public virtual System.Data.DataSet Select(Characters query) {
            this.Access.CreateProcedureCommand("ssp_Characters");
            if (query.SysId == null) {
            ...
            if (query.CharacterStatusSysId == null) {
                this.Access.AddParameter("CharacterStatusSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("CharacterStatusSysId",query.CharacterStatusSysId, ParameterDirection.Input);
            }
            if (query.CharacterTypeSysId == null) {
                this.Access.AddParameter("CharacterTypeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("CharacterTypeSysId",query.CharacterTypeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pCharacterStatusSysId, System.Nullable<int> pCharacterTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Characters");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            this.Access.AddParameter("SysId", pSysId, ParameterDirection.Input);
            this.Access.AddParameter("CharacterStatusSysId", pCharacterStatusSysId, ParameterDirection.Input);
            this.Access.AddParameter("CharacterTypeSysId", pCharacterTypeSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(Characters query) {
            this.Access.CreateProcedureCommand("cp_Characters");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(Characters query) {
            this.Access.CreateProcedureCommand("cp_Characters");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pCharacterStatusSysId, System.Nullable<int> pCharacterTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Characters");
        ...
        // Inserts a record
        public virtual int Insert(Characters query) {
            this.Access.CreateProcedureCommand("cp_Characters");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
