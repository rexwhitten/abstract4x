namespace Space.Data.Space {
    ...
    public partial class AsteroidFiledStatusDAL : Space.Data.DataAccessBase {
        
        public AsteroidFiledStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private AsteroidFiledStatus Fill(System.Data.DataRow row) {
            AsteroidFiledStatus obj = new AsteroidFiledStatus();
        ...
        public virtual Collection<AsteroidFiledStatus> SelectObjects(AsteroidFiledStatus query) {
            Collection<AsteroidFiledStatus> objs = new Collection<AsteroidFiledStatus>();
...
while(e.MoveNext()) { 
 ...
 AsteroidFiledStatus obj = Fill(row);
 objs.Add(obj);
 }
            return objs;
        }
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledStatus");
        ...
        public virtual System.Data.DataSet Select(AsteroidFiledStatus query) {
            this.Access.CreateProcedureCommand("ssp_AsteroidFiledStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(AsteroidFiledStatus query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(AsteroidFiledStatus query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(AsteroidFiledStatus query) {
            this.Access.CreateProcedureCommand("cp_AsteroidFiledStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
