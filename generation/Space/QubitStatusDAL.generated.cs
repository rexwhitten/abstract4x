namespace Space.Data.Space {
    ...
    public partial class QubitStatusDAL : Space.Data.DataAccessBase {
        
        public QubitStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private QubitStatus Fill(System.Data.DataRow row) {
            QubitStatus obj = new QubitStatus();
        ...
        public virtual Collection<QubitStatus> SelectObjects(QubitStatus query) {
            Collection<QubitStatus> objs = new Collection<QubitStatus>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_QubitStatus");
        ...
        public virtual System.Data.DataSet Select(QubitStatus query) {
            this.Access.CreateProcedureCommand("ssp_QubitStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(QubitStatus query) {
            this.Access.CreateProcedureCommand("cp_QubitStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(QubitStatus query) {
            this.Access.CreateProcedureCommand("cp_QubitStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(QubitStatus query) {
            this.Access.CreateProcedureCommand("cp_QubitStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
