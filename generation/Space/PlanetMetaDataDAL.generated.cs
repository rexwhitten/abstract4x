namespace Space.Data.Space {
    ...
    public partial class PlanetMetaDataDAL : Space.Data.DataAccessBase {
        
        public PlanetMetaDataDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private PlanetMetaData Fill(System.Data.DataRow row) {
            PlanetMetaData obj = new PlanetMetaData();
            ...
            if ((row["PlanetSysId"] != System.DBNull.Value)) {
                obj.PlanetSysId = ((int?)(row["PlanetSysId"]));
            }
        ...
        public virtual Collection<PlanetMetaData> SelectObjects(PlanetMetaData query) {
            Collection<PlanetMetaData> objs = new Collection<PlanetMetaData>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_PlanetMetaData");
        ...
        public virtual System.Data.DataSet Select(PlanetMetaData query) {
            this.Access.CreateProcedureCommand("ssp_PlanetMetaData");
            if (query.SysId == null) {
            ...
            if (query.PlanetSysId == null) {
                this.Access.AddParameter("PlanetSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("PlanetSysId",query.PlanetSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pPlanetSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_PlanetMetaData");
            ...
            this.Access.AddParameter("PlanetSysId", pPlanetSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(PlanetMetaData query) {
            this.Access.CreateProcedureCommand("cp_PlanetMetaData");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(PlanetMetaData query) {
            this.Access.CreateProcedureCommand("cp_PlanetMetaData");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pPlanetSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_PlanetMetaData");
        ...
        // Inserts a record
        public virtual int Insert(PlanetMetaData query) {
            this.Access.CreateProcedureCommand("cp_PlanetMetaData");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
