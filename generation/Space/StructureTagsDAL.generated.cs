namespace Space.Data.Space {
    ...
    public partial class StructureTagsDAL : Space.Data.DataAccessBase {
        
        public StructureTagsDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private StructureTags Fill(System.Data.DataRow row) {
            StructureTags obj = new StructureTags();
        ...
        public virtual Collection<StructureTags> SelectObjects(StructureTags query) {
            Collection<StructureTags> objs = new Collection<StructureTags>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_StructureTags");
        ...
        public virtual System.Data.DataSet Select(StructureTags query) {
            this.Access.CreateProcedureCommand("ssp_StructureTags");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pStructureSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_StructureTags");
        ...
        // Updates a Record
        public virtual int Update(StructureTags query) {
            this.Access.CreateProcedureCommand("cp_StructureTags");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(StructureTags query) {
            this.Access.CreateProcedureCommand("cp_StructureTags");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pStructureSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_StructureTags");
        ...
        // Inserts a record
        public virtual int Insert(StructureTags query) {
            this.Access.CreateProcedureCommand("cp_StructureTags");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
