namespace Space.Data.Space {
    ...
    public partial class LocationStatusDAL : Space.Data.DataAccessBase {
        
        public LocationStatusDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private LocationStatus Fill(System.Data.DataRow row) {
            LocationStatus obj = new LocationStatus();
        ...
        public virtual Collection<LocationStatus> SelectObjects(LocationStatus query) {
            Collection<LocationStatus> objs = new Collection<LocationStatus>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_LocationStatus");
        ...
        public virtual System.Data.DataSet Select(LocationStatus query) {
            this.Access.CreateProcedureCommand("ssp_LocationStatus");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(LocationStatus query) {
            this.Access.CreateProcedureCommand("cp_LocationStatus");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(LocationStatus query) {
            this.Access.CreateProcedureCommand("cp_LocationStatus");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(LocationStatus query) {
            this.Access.CreateProcedureCommand("cp_LocationStatus");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
