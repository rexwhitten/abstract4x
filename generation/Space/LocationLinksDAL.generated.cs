namespace Space.Data.Space {
    ...
    public partial class LocationLinksDAL : Space.Data.DataAccessBase {
        
        public LocationLinksDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private LocationLinks Fill(System.Data.DataRow row) {
            LocationLinks obj = new LocationLinks();
            ...
            if ((row["ParentLocationSysId"] != System.DBNull.Value)) {
                obj.ParentLocationSysId = ((int?)(row["ParentLocationSysId"]));
            }
            if ((row["ChildLocationSysId"] != System.DBNull.Value)) {
                obj.ChildLocationSysId = ((int?)(row["ChildLocationSysId"]));
            }
        ...
        public virtual Collection<LocationLinks> SelectObjects(LocationLinks query) {
            Collection<LocationLinks> objs = new Collection<LocationLinks>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_LocationLinks");
        ...
        public virtual System.Data.DataSet Select(LocationLinks query) {
            this.Access.CreateProcedureCommand("ssp_LocationLinks");
            if (query.SysId == null) {
            ...
            if (query.ParentLocationSysId == null) {
                this.Access.AddParameter("ParentLocationSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ParentLocationSysId",query.ParentLocationSysId, ParameterDirection.Input);
            }
            if (query.ChildLocationSysId == null) {
                this.Access.AddParameter("ChildLocationSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ChildLocationSysId",query.ChildLocationSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentLocationSysId, System.Nullable<int> pChildLocationSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_LocationLinks");
            ...
            this.Access.AddParameter("ParentLocationSysId", pParentLocationSysId, ParameterDirection.Input);
            this.Access.AddParameter("ChildLocationSysId", pChildLocationSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(LocationLinks query) {
            this.Access.CreateProcedureCommand("cp_LocationLinks");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(LocationLinks query) {
            this.Access.CreateProcedureCommand("cp_LocationLinks");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentLocationSysId, System.Nullable<int> pChildLocationSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_LocationLinks");
        ...
        // Inserts a record
        public virtual int Insert(LocationLinks query) {
            this.Access.CreateProcedureCommand("cp_LocationLinks");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
