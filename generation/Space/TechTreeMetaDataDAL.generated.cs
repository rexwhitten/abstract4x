namespace Space.Data.Space {
    ...
    public partial class TechTreeMetaDataDAL : Space.Data.DataAccessBase {
        
        public TechTreeMetaDataDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private TechTreeMetaData Fill(System.Data.DataRow row) {
            TechTreeMetaData obj = new TechTreeMetaData();
            ...
            if ((row["TechTreeSysId"] != System.DBNull.Value)) {
                obj.TechTreeSysId = ((int?)(row["TechTreeSysId"]));
            }
        ...
        public virtual Collection<TechTreeMetaData> SelectObjects(TechTreeMetaData query) {
            Collection<TechTreeMetaData> objs = new Collection<TechTreeMetaData>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_TechTreeMetaData");
        ...
        public virtual System.Data.DataSet Select(TechTreeMetaData query) {
            this.Access.CreateProcedureCommand("ssp_TechTreeMetaData");
            if (query.SysId == null) {
            ...
            if (query.TechTreeSysId == null) {
                this.Access.AddParameter("TechTreeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("TechTreeSysId",query.TechTreeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pTechTreeSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_TechTreeMetaData");
            ...
            this.Access.AddParameter("TechTreeSysId", pTechTreeSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(TechTreeMetaData query) {
            this.Access.CreateProcedureCommand("cp_TechTreeMetaData");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(TechTreeMetaData query) {
            this.Access.CreateProcedureCommand("cp_TechTreeMetaData");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pTechTreeSysId, string pKeyPath, string pKeyValue, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_TechTreeMetaData");
        ...
        // Inserts a record
        public virtual int Insert(TechTreeMetaData query) {
            this.Access.CreateProcedureCommand("cp_TechTreeMetaData");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
