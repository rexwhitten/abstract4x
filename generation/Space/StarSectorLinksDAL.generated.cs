namespace Space.Data.Space {
    ...
    public partial class StarSectorLinksDAL : Space.Data.DataAccessBase {
        
        public StarSectorLinksDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private StarSectorLinks Fill(System.Data.DataRow row) {
            StarSectorLinks obj = new StarSectorLinks();
            ...
            if ((row["ParentStarSectorSysId"] != System.DBNull.Value)) {
                obj.ParentStarSectorSysId = ((int?)(row["ParentStarSectorSysId"]));
            }
            if ((row["ChildStarSectorSysId"] != System.DBNull.Value)) {
                obj.ChildStarSectorSysId = ((int?)(row["ChildStarSectorSysId"]));
            }
        ...
        public virtual Collection<StarSectorLinks> SelectObjects(StarSectorLinks query) {
            Collection<StarSectorLinks> objs = new Collection<StarSectorLinks>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_StarSectorLinks");
        ...
        public virtual System.Data.DataSet Select(StarSectorLinks query) {
            this.Access.CreateProcedureCommand("ssp_StarSectorLinks");
            if (query.SysId == null) {
            ...
            if (query.ParentStarSectorSysId == null) {
                this.Access.AddParameter("ParentStarSectorSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ParentStarSectorSysId",query.ParentStarSectorSysId, ParameterDirection.Input);
            }
            if (query.ChildStarSectorSysId == null) {
                this.Access.AddParameter("ChildStarSectorSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ChildStarSectorSysId",query.ChildStarSectorSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentStarSectorSysId, System.Nullable<int> pChildStarSectorSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_StarSectorLinks");
            ...
            this.Access.AddParameter("ParentStarSectorSysId", pParentStarSectorSysId, ParameterDirection.Input);
            this.Access.AddParameter("ChildStarSectorSysId", pChildStarSectorSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(StarSectorLinks query) {
            this.Access.CreateProcedureCommand("cp_StarSectorLinks");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(StarSectorLinks query) {
            this.Access.CreateProcedureCommand("cp_StarSectorLinks");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentStarSectorSysId, System.Nullable<int> pChildStarSectorSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_StarSectorLinks");
        ...
        // Inserts a record
        public virtual int Insert(StarSectorLinks query) {
            this.Access.CreateProcedureCommand("cp_StarSectorLinks");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
