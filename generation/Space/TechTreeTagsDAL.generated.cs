namespace Space.Data.Space {
    ...
    public partial class TechTreeTagsDAL : Space.Data.DataAccessBase {
        
        public TechTreeTagsDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private TechTreeTags Fill(System.Data.DataRow row) {
            TechTreeTags obj = new TechTreeTags();
        ...
        public virtual Collection<TechTreeTags> SelectObjects(TechTreeTags query) {
            Collection<TechTreeTags> objs = new Collection<TechTreeTags>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_TechTreeTags");
        ...
        public virtual System.Data.DataSet Select(TechTreeTags query) {
            this.Access.CreateProcedureCommand("ssp_TechTreeTags");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pTechTreeSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_TechTreeTags");
        ...
        // Updates a Record
        public virtual int Update(TechTreeTags query) {
            this.Access.CreateProcedureCommand("cp_TechTreeTags");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(TechTreeTags query) {
            this.Access.CreateProcedureCommand("cp_TechTreeTags");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pTechTreeSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_TechTreeTags");
        ...
        // Inserts a record
        public virtual int Insert(TechTreeTags query) {
            this.Access.CreateProcedureCommand("cp_TechTreeTags");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
