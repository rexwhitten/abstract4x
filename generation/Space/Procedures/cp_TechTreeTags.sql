-- =============================================================================
-- Name:		cp_TechTreeTags
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:34 PM
-- Description:	Provides CRUD access to [Space].[dbo].[TechTreeTags]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_TechTreeTags]
	 @Operation     	[INT]             	= 0
	,@Active        	[BIT]             	= NULL
