...
-- Created On:	10/26/2014 5:36:41 PM
-- Description:	Provides CRUD access to [Space].[dbo].[ActorTypes]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_ActorTypes]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
