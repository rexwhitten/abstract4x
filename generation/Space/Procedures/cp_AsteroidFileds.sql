-- =============================================================================
-- Name:		cp_AsteroidFileds
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:36:43 PM
-- Description:	Provides CRUD access to [Space].[dbo].[AsteroidFileds]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_AsteroidFileds]
	 @Operation                	[INT]                	= 0
	,@Active                   	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[AsteroidFileds]
			SET		 [Active]                   	= @Active
					,[AsteroidFiledStatusSysId] 	= @AsteroidFiledStatusSysId
					,[AsteroidFiledTypeSysId]   	= @AsteroidFiledTypeSysId
