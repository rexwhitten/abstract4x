-- =============================================================================
-- Name:		cp_StarSectorTypes
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:26 PM
-- Description:	Provides CRUD access to [Space].[dbo].[StarSectorTypes]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_StarSectorTypes]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 1 )
		BEGIN
			SELECT	 [Active]
					...
					,[PublicId]
					,[SysId]
			FROM	[Space].[dbo].[StarSectorTypes]
			WHERE	[SysId] = @SysId
		END
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[StarSectorTypes]
			SET		 [Active]           	= @Active
