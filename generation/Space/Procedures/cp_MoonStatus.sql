...
-- Created On:	10/26/2014 5:37:00 PM
-- Description:	Provides CRUD access to [Space].[dbo].[MoonStatus]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_MoonStatus]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
