-- =============================================================================
-- Name:		cp_GalaxyStatus
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:36:53 PM
-- Description:	Provides CRUD access to [Space].[dbo].[GalaxyStatus]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_GalaxyStatus]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
