-- =============================================================================
-- Name:		cp_PlanetMetaData
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:06 PM
-- Description:	Provides CRUD access to [Space].[dbo].[PlanetMetaData]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_PlanetMetaData]
	 @Operation   	[INT]                	= 0
	,@Active      	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[PlanetMetaData]
			SET		 [Active]      	= @Active
					,[KeyPath]     	= @KeyPath
					,[KeyValue]    	= @KeyValue
					,[PlanetSysId] 	= @PlanetSysId
					,[PublicId]    	= @PublicId
			WHERE	[SysId] = @SysId
		END
