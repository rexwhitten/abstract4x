-- =============================================================================
-- Name:		cp_TechTreeLinks
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:32 PM
-- Description:	Provides CRUD access to [Space].[dbo].[TechTreeLinks]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_TechTreeLinks]
	 @Operation           	[INT]                	= 0
	,@Active              	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[TechTreeLinks]
			SET		 [Active]              	= @Active
					,[ChildTechTreeSysId]  	= @ChildTechTreeSysId
					,[CreateDate]          	= @CreateDate
					,[LastModifiedDate]    	= @LastModifiedDate
					,[LinkPath]            	= @LinkPath
					,[ParentTechTreeSysId] 	= @ParentTechTreeSysId
					,[PublicId]            	= @PublicId
			WHERE	[SysId] = @SysId
		END
