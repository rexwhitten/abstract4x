...
-- Description:	Provides CRUD access to [Space].[dbo].[QubitsTags]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_QubitsTags]
	 @Operation   	[INT]             	= 0
	,@Active      	[BIT]             	= NULL
