...
-- Created On:	10/26/2014 5:37:01 PM
-- Description:	Provides CRUD access to [Space].[dbo].[MoonTypes]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_MoonTypes]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
