...
-- Created On:	10/26/2014 5:37:16 PM
-- Description:	Provides CRUD access to [Space].[dbo].[QubitsLinks]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_QubitsLinks]
	 @Operation         	[INT]                	= 0
	,@Active            	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[QubitsLinks]
			SET		 [Active]            	= @Active
					,[ChildQubitsSysId]  	= @ChildQubitsSysId
					,[CreateDate]        	= @CreateDate
					,[LastModifiedDate]  	= @LastModifiedDate
					,[LinkPath]          	= @LinkPath
					,[ParentQubitsSysId] 	= @ParentQubitsSysId
					,[PublicId]          	= @PublicId
			WHERE	[SysId] = @SysId
		END
