-- =============================================================================
-- Name:		cp_PlayerAttributes
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:09 PM
-- Description:	Provides CRUD access to [Space].[dbo].[PlayerAttributes]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_PlayerAttributes]
	 @Operation        	[INT]             	= 0
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 1 )
		BEGIN
			SELECT	 [CreateDate]
					...
					,[SysId]
					,[Username]
			FROM	[Space].[dbo].[PlayerAttributes]
			WHERE	[SysId] = @SysId
		END
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[PlayerAttributes]
			SET		 [CreateDate]       	= @CreateDate
					,[Email]            	= @Email
					,[LastModifiedDate] 	= @LastModifiedDate
					,[PasswordHash]     	= @PasswordHash
					,[PlayerSysId]      	= @PlayerSysId
					,[Username]         	= @Username
			WHERE	[SysId] = @SysId
		END
