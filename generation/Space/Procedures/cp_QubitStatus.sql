...
-- Created On:	10/26/2014 5:37:19 PM
-- Description:	Provides CRUD access to [Space].[dbo].[QubitStatus]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_QubitStatus]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
