-- =============================================================================
-- Name:		cp_CharacterLinks
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:36:46 PM
-- Description:	Provides CRUD access to [Space].[dbo].[CharacterLinks]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_CharacterLinks]
	 @Operation            	[INT]                	= 0
	,@Active               	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[CharacterLinks]
			SET		 [Active]               	= @Active
					,[ChildCharacterSysId]  	= @ChildCharacterSysId
					,[CreateDate]           	= @CreateDate
					,[LastModifiedDate]     	= @LastModifiedDate
					,[LinkPath]             	= @LinkPath
					,[ParentCharacterSysId] 	= @ParentCharacterSysId
					,[PublicId]             	= @PublicId
			WHERE	[SysId] = @SysId
		END
