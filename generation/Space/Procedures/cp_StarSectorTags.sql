-- =============================================================================
-- Name:		cp_StarSectorTags
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:25 PM
-- Description:	Provides CRUD access to [Space].[dbo].[StarSectorTags]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_StarSectorTags]
	 @Operation       	[INT]             	= 0
	,@Active          	[BIT]             	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[StarSectorTags]
			SET		 [Active]          	= @Active
					,[CreateDate]      	= @CreateDate
					,[StarSectorSysId] 	= @StarSectorSysId
					,[Tag]             	= @Tag
			WHERE	[SysId] = @SysId
		END
