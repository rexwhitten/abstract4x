...
-- Created On:	10/26/2014 5:36:56 PM
-- Description:	Provides CRUD access to [Space].[dbo].[Locations]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_Locations]
	 @Operation           	[INT]                	= 0
	,@Active              	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[Locations]
			SET		 [Active]              	= @Active
					,[CreateDate]          	= @CreateDate
					,[Is_ReadOnly]         	= @Is_ReadOnly
					,[LastModifiedDate]    	= @LastModifiedDate
					,[LocationStatusSysId] 	= @LocationStatusSysId
					,[LocationTypeSysId]   	= @LocationTypeSysId
					,[Path]                	= @Path
					,[PublicId]            	= @PublicId
			WHERE	[SysId] = @SysId
		END
