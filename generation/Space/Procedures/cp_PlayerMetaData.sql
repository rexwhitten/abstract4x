...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_PlayerMetaData]
	 @Operation   	[INT]                	= 0
	,@Active      	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[PlayerMetaData]
			SET		 [Active]      	= @Active
					,[KeyPath]     	= @KeyPath
					,[KeyValue]    	= @KeyValue
