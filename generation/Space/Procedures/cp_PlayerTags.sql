...
-- Created On:	10/26/2014 5:37:12 PM
-- Description:	Provides CRUD access to [Space].[dbo].[PlayerTags]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_PlayerTags]
	 @Operation   	[INT]             	= 0
	,@Active      	[BIT]             	= NULL
