...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_StarSectorMetaData]
	 @Operation       	[INT]                	= 0
	,@Active          	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 1 )
		BEGIN
			SELECT	 [Active]
					...
					,[StarSectorSysId]
					,[SysId]
			FROM	[Space].[dbo].[StarSectorMetaData]
			WHERE	[SysId] = @SysId
		END
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[StarSectorMetaData]
			SET		 [Active]          	= @Active
					,[KeyPath]         	= @KeyPath
					,[KeyValue]        	= @KeyValue
					,[PublicId]        	= @PublicId
