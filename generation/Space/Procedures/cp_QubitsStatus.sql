-- =============================================================================
-- Name:		cp_QubitsStatus
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:18 PM
-- Description:	Provides CRUD access to [Space].[dbo].[QubitsStatus]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_QubitsStatus]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
