...
-- Created On:	10/26/2014 5:36:40 PM
-- Description:	Provides CRUD access to [Space].[dbo].[ActorStatus]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_ActorStatus]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
