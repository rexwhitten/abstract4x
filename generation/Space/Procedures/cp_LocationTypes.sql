-- =============================================================================
-- Name:		cp_LocationTypes
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:36:57 PM
-- Description:	Provides CRUD access to [Space].[dbo].[LocationTypes]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_LocationTypes]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[LocationTypes]
			SET		 [Active]           	= @Active
