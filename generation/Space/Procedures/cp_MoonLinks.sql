...
-- Created On:	10/26/2014 5:36:58 PM
-- Description:	Provides CRUD access to [Space].[dbo].[MoonLinks]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_MoonLinks]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[MoonLinks]
			SET		 [Active]           	= @Active
					,[ChildMoonSysId]   	= @ChildMoonSysId
					,[CreateDate]       	= @CreateDate
					,[LastModifiedDate] 	= @LastModifiedDate
					,[LinkPath]         	= @LinkPath
					,[ParentMoonSysId]  	= @ParentMoonSysId
					,[PublicId]         	= @PublicId
			WHERE	[SysId] = @SysId
		END
