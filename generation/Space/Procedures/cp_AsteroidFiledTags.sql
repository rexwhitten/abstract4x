-- =============================================================================
-- Name:		cp_AsteroidFiledTags
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:36:44 PM
-- Description:	Provides CRUD access to [Space].[dbo].[AsteroidFiledTags]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_AsteroidFiledTags]
	 @Operation          	[INT]             	= 0
	,@Active             	[BIT]             	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 1 )
		BEGIN
			SELECT	 [Active]
					...
					,[SysId]
					,[Tag]
			FROM	[Space].[dbo].[AsteroidFiledTags]
			WHERE	[SysId] = @SysId
		END
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[AsteroidFiledTags]
			SET		 [Active]             	= @Active
