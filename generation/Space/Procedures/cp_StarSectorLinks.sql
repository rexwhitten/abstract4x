-- =============================================================================
-- Name:		cp_StarSectorLinks
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:23 PM
-- Description:	Provides CRUD access to [Space].[dbo].[StarSectorLinks]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_StarSectorLinks]
	 @Operation             	[INT]                	= 0
	,@Active                	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 1 )
		BEGIN
			SELECT	 [Active]
					...
					,[PublicId]
					,[SysId]
			FROM	[Space].[dbo].[StarSectorLinks]
			WHERE	[SysId] = @SysId
		END
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[StarSectorLinks]
			SET		 [Active]                	= @Active
					,[ChildStarSectorSysId]  	= @ChildStarSectorSysId
					,[CreateDate]            	= @CreateDate
					,[LastModifiedDate]      	= @LastModifiedDate
					,[LinkPath]              	= @LinkPath
					,[ParentStarSectorSysId] 	= @ParentStarSectorSysId
					,[PublicId]              	= @PublicId
			WHERE	[SysId] = @SysId
		END
