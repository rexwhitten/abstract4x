-- =============================================================================
-- Name:		cp_LocationLinks
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:36:54 PM
-- Description:	Provides CRUD access to [Space].[dbo].[LocationLinks]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_LocationLinks]
	 @Operation           	[INT]                	= 0
	,@Active              	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[LocationLinks]
			SET		 [Active]              	= @Active
					,[ChildLocationSysId]  	= @ChildLocationSysId
					,[CreateDate]          	= @CreateDate
					,[LastModifiedDate]    	= @LastModifiedDate
					,[LinkPath]            	= @LinkPath
					,[ParentLocationSysId] 	= @ParentLocationSysId
					,[PublicId]            	= @PublicId
			WHERE	[SysId] = @SysId
		END
