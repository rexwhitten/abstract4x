-- =============================================================================
-- Name:		cp_ActorMetaData
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:36:38 PM
-- Description:	Provides CRUD access to [Space].[dbo].[ActorMetaData]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_ActorMetaData]
	 @Operation  	[INT]                	= 0
	,@Active     	[BIT]                	= NULL
	,@ActorSysId 	[INT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[ActorMetaData]
			SET		 [Active]     	= @Active
