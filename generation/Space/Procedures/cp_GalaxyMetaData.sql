...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_GalaxyMetaData]
	 @Operation   	[INT]                	= 0
	,@Active      	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[GalaxyMetaData]
			SET		 [Active]      	= @Active
					,[GalaxySysId] 	= @GalaxySysId
					,[KeyPath]     	= @KeyPath
					,[KeyValue]    	= @KeyValue
					,[PublicId]    	= @PublicId
			WHERE	[SysId] = @SysId
