...
-- Created On:	10/26/2014 5:37:10 PM
-- Description:	Provides CRUD access to [Space].[dbo].[PlayerLinks]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_PlayerLinks]
	 @Operation         	[INT]                	= 0
	,@Active            	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[PlayerLinks]
			SET		 [Active]            	= @Active
					,[ChildPlayerSysId]  	= @ChildPlayerSysId
					,[CreateDate]        	= @CreateDate
					,[LastModifiedDate]  	= @LastModifiedDate
					,[LinkPath]          	= @LinkPath
					,[ParentPlayerSysId] 	= @ParentPlayerSysId
					,[PublicId]          	= @PublicId
			WHERE	[SysId] = @SysId
		END
