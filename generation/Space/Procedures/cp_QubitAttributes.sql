-- =============================================================================
-- Name:		cp_QubitAttributes
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:13 PM
-- Description:	Provides CRUD access to [Space].[dbo].[QubitAttributes]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_QubitAttributes]
	 @Operation        	[INT]             	= 0
	,@Amount           	[INT]             	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 1 )
		BEGIN
			SELECT	 [Amount]
					...
					,[QubitSysId]
					,[SysId]
			FROM	[Space].[dbo].[QubitAttributes]
			WHERE	[SysId] = @SysId
		END
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[QubitAttributes]
			SET		 [Amount]           	= @Amount
