-- =============================================================================
-- Name:		cp_LocationMetaData
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:36:55 PM
-- Description:	Provides CRUD access to [Space].[dbo].[LocationMetaData]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_LocationMetaData]
	 @Operation     	[INT]                	= 0
	,@Active        	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 1 )
		BEGIN
			SELECT	 [Active]
					...
					,[PublicId]
					,[SysId]
			FROM	[Space].[dbo].[LocationMetaData]
			WHERE	[SysId] = @SysId
		END
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[LocationMetaData]
			SET		 [Active]        	= @Active
					,[KeyPath]       	= @KeyPath
					,[KeyValue]      	= @KeyValue
