...
-- Description:	Provides CRUD access to [Space].[dbo].[Qubits]
--
	...
	IF( @Operation = 4 )
		BEGIN
			...
			SET		 [Active]           	= @Active
					...
					,[Path]             	= @Path
					,[PublicId]         	= @PublicId
					,[QubitStatusSysId] 	= @QubitStatusSysId
					,[QubitTypeSysId]   	= @QubitTypeSysId
			WHERE	[SysId] = @SysId
		END
