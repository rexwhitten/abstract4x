-- =============================================================================
-- Name:		cp_CharacterQubits
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:36:47 PM
-- Description:	Provides CRUD access to [Space].[dbo].[CharacterQubits]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_CharacterQubits]
	 @Operation      	[INT]                	= 0
	,@Active         	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 1 )
		BEGIN
			SELECT	 [Active]
					...
					,[QubitsysId]
					,[SysId]
			FROM	[Space].[dbo].[CharacterQubits]
			WHERE	[SysId] = @SysId
		END
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[CharacterQubits]
			SET		 [Active]         	= @Active
					,[CharacterSysId] 	= @CharacterSysId
					,[CreateDate]     	= @CreateDate
					,[Path]           	= @Path
					,[PublicId]       	= @PublicId
					,[QubitsysId]     	= @QubitsysId
			WHERE	[SysId] = @SysId
		END
