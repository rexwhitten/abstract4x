...
-- Created On:	10/26/2014 5:37:21 PM
-- Description:	Provides CRUD access to [Space].[dbo].[StarLinks]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_StarLinks]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[StarLinks]
			SET		 [Active]           	= @Active
					,[ChildStarSysId]   	= @ChildStarSysId
					,[CreateDate]       	= @CreateDate
					,[LastModifiedDate] 	= @LastModifiedDate
					,[LinkPath]         	= @LinkPath
					,[ParentStarSysId]  	= @ParentStarSysId
					,[PublicId]         	= @PublicId
			WHERE	[SysId] = @SysId
		END
