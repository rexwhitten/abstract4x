...
-- Created On:	10/26/2014 5:36:39 PM
-- Description:	Provides CRUD access to [Space].[dbo].[Actors]
--
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[Actors]
			SET		 [Active]           	= @Active
					,[ActorStatusSysId] 	= @ActorStatusSysId
					,[ActorTypeSysId]   	= @ActorTypeSysId
