...
-- Created On:	10/26/2014 5:36:36 PM
-- Description:	Provides CRUD access to [Space].[dbo].[ActorLinks]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_ActorLinks]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[ActorLinks]
			SET		 [Active]           	= @Active
					,[ChildActorSysId]  	= @ChildActorSysId
					,[CreateDate]       	= @CreateDate
					,[LastModifiedDate] 	= @LastModifiedDate
					,[LinkPath]         	= @LinkPath
					,[ParentActorSysId] 	= @ParentActorSysId
					,[PublicId]         	= @PublicId
			WHERE	[SysId] = @SysId
		END
