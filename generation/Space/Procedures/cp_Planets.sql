...
-- Created On:	10/26/2014 5:37:07 PM
-- Description:	Provides CRUD access to [Space].[dbo].[Planets]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_Planets]
	 @Operation         	[INT]                	= 0
	,@Active            	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[Planets]
			SET		 [Active]            	= @Active
					,[CreateDate]        	= @CreateDate
					,[Is_ReadOnly]       	= @Is_ReadOnly
					,[LastModifiedDate]  	= @LastModifiedDate
					,[Path]              	= @Path
					,[PlanetStatusSysId] 	= @PlanetStatusSysId
					,[PlanetTypeSysId]   	= @PlanetTypeSysId
					,[PublicId]          	= @PublicId
			WHERE	[SysId] = @SysId
		END
