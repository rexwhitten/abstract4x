-- =============================================================================
-- Name:		cp_CharacterAttributes
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:36:45 PM
-- Description:	Provides CRUD access to [Space].[dbo].[CharacterAttributes]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_CharacterAttributes]
	 @Operation        	[INT]             	= 0
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 1 )
		BEGIN
			SELECT	 [CharacterSysId]
					,[CreateDate]
					,[LastModifiedDate]
					,[Level]
					,[Score]
					,[SysId]
			FROM	[Space].[dbo].[CharacterAttributes]
			WHERE	[SysId] = @SysId
		END
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[CharacterAttributes]
			SET		 [CharacterSysId]   	= @CharacterSysId
