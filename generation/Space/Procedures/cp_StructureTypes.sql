-- =============================================================================
-- Name:		cp_StructureTypes
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:31 PM
-- Description:	Provides CRUD access to [Space].[dbo].[StructureTypes]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_StructureTypes]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[StructureTypes]
			SET		 [Active]           	= @Active
