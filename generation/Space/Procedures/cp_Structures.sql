...
-- Description:	Provides CRUD access to [Space].[dbo].[Structures]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_Structures]
	 @Operation            	[INT]                	= 0
	,@Active               	[BIT]                	= NULL
	...
	IF( @Operation = 4 )
		BEGIN
			...
			SET		 [Active]               	= @Active
					...
					,[Path]                 	= @Path
					,[PublicId]             	= @PublicId
					,[StructureStatusSysId] 	= @StructureStatusSysId
					,[StructureTypeSysId]   	= @StructureTypeSysId
			WHERE	[SysId] = @SysId
		END
