...
-- Created On:	10/26/2014 5:36:51 PM
-- Description:	Provides CRUD access to [Space].[dbo].[GalaxyLinks]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_GalaxyLinks]
	 @Operation         	[INT]                	= 0
	,@Active            	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[GalaxyLinks]
			SET		 [Active]            	= @Active
					,[ChildGalaxySysId]  	= @ChildGalaxySysId
					,[CreateDate]        	= @CreateDate
					,[LastModifiedDate]  	= @LastModifiedDate
					,[LinkPath]          	= @LinkPath
					,[ParentGalaxySysId] 	= @ParentGalaxySysId
					,[PublicId]          	= @PublicId
			WHERE	[SysId] = @SysId
		END
