...
-- Created On:	10/26/2014 5:37:33 PM
-- Description:	Provides CRUD access to [Space].[dbo].[TechTrees]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_TechTrees]
	 @Operation           	[INT]                	= 0
	,@Active              	[BIT]                	= NULL
	...
	IF( @Operation = 4 )
		BEGIN
			...
			SET		 [Active]              	= @Active
					...
					,[Path]                	= @Path
					,[PublicId]            	= @PublicId
					,[TechTreeStatusSysId] 	= @TechTreeStatusSysId
					,[TechTreeTypeSysId]   	= @TechTreeTypeSysId
			WHERE	[SysId] = @SysId
		END
