-- =============================================================================
-- Name:		cp_MoonMetaData
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:36:59 PM
-- Description:	Provides CRUD access to [Space].[dbo].[MoonMetaData]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_MoonMetaData]
	 @Operation 	[INT]                	= 0
	,@Active    	[BIT]                	= NULL
