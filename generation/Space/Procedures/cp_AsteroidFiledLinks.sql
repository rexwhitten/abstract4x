-- =============================================================================
-- Name:		cp_AsteroidFiledLinks
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:36:42 PM
-- Description:	Provides CRUD access to [Space].[dbo].[AsteroidFiledLinks]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_AsteroidFiledLinks]
	 @Operation                	[INT]                	= 0
	,@Active                   	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 1 )
		BEGIN
			SELECT	 [Active]
					...
					,[PublicId]
					,[SysId]
			FROM	[Space].[dbo].[AsteroidFiledLinks]
			WHERE	[SysId] = @SysId
		END
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[AsteroidFiledLinks]
			SET		 [Active]                   	= @Active
					,[ChildAsteroidFiledSysId]  	= @ChildAsteroidFiledSysId
					,[CreateDate]               	= @CreateDate
					,[LastModifiedDate]         	= @LastModifiedDate
					,[LinkPath]                 	= @LinkPath
					,[ParentAsteroidFiledSysId] 	= @ParentAsteroidFiledSysId
					,[PublicId]                 	= @PublicId
			WHERE	[SysId] = @SysId
		END
