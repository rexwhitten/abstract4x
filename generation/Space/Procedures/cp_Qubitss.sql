...
-- Description:	Provides CRUD access to [Space].[dbo].[Qubitss]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_Qubitss]
	 @Operation         	[INT]                	= 0
	,@Active            	[BIT]                	= NULL
	...
	IF( @Operation = 4 )
		BEGIN
			...
			SET		 [Active]            	= @Active
					...
					,[Path]              	= @Path
					,[PublicId]          	= @PublicId
					,[QubitsStatusSysId] 	= @QubitsStatusSysId
					,[QubitsTypeSysId]   	= @QubitsTypeSysId
			WHERE	[SysId] = @SysId
		END
