-- =============================================================================
-- Name:		cp_StructureTags
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:30 PM
-- Description:	Provides CRUD access to [Space].[dbo].[StructureTags]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_StructureTags]
	 @Operation      	[INT]             	= 0
	,@Active         	[BIT]             	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[StructureTags]
			SET		 [Active]         	= @Active
