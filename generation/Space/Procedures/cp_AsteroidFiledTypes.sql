...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_AsteroidFiledTypes]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 1 )
		BEGIN
			SELECT	 [Active]
					...
					,[PublicId]
					,[SysId]
			FROM	[Space].[dbo].[AsteroidFiledTypes]
			WHERE	[SysId] = @SysId
		END
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[AsteroidFiledTypes]
			SET		 [Active]           	= @Active
