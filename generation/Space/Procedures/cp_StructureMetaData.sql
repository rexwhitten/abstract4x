-- =============================================================================
-- Name:		cp_StructureMetaData
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:29 PM
-- Description:	Provides CRUD access to [Space].[dbo].[StructureMetaData]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_StructureMetaData]
	 @Operation      	[INT]                	= 0
	,@Active         	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 1 )
		BEGIN
			SELECT	 [Active]
					...
					,[StructureSysId]
					,[SysId]
			FROM	[Space].[dbo].[StructureMetaData]
			WHERE	[SysId] = @SysId
		END
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[StructureMetaData]
			SET		 [Active]         	= @Active
					,[KeyPath]        	= @KeyPath
					,[KeyValue]       	= @KeyValue
					,[PublicId]       	= @PublicId
					,[StructureSysId] 	= @StructureSysId
			WHERE	[SysId] = @SysId
		END
