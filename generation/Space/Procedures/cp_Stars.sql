...
-- Created On:	10/26/2014 5:37:22 PM
-- Description:	Provides CRUD access to [Space].[dbo].[Stars]
--
	...
	IF( @Operation = 4 )
		BEGIN
			...
			SET		 [Active]           	= @Active
					...
					,[Path]             	= @Path
					,[PublicId]         	= @PublicId
					,[StarStatusSysId]  	= @StarStatusSysId
					,[StarTypeSysId]    	= @StarTypeSysId
			WHERE	[SysId] = @SysId
		END
