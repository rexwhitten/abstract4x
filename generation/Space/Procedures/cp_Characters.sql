...
-- Created On:	10/26/2014 5:36:48 PM
-- Description:	Provides CRUD access to [Space].[dbo].[Characters]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_Characters]
	 @Operation            	[INT]                	= 0
	,@Active               	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[Characters]
			SET		 [Active]               	= @Active
					,[CharacterStatusSysId] 	= @CharacterStatusSysId
					,[CharacterTypeSysId]   	= @CharacterTypeSysId
