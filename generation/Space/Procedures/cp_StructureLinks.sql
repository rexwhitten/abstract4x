-- =============================================================================
-- Name:		cp_StructureLinks
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:28 PM
-- Description:	Provides CRUD access to [Space].[dbo].[StructureLinks]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_StructureLinks]
	 @Operation            	[INT]                	= 0
	,@Active               	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[StructureLinks]
			SET		 [Active]               	= @Active
					,[ChildStructureSysId]  	= @ChildStructureSysId
					,[CreateDate]           	= @CreateDate
					,[LastModifiedDate]     	= @LastModifiedDate
					,[LinkPath]             	= @LinkPath
					,[ParentStructureSysId] 	= @ParentStructureSysId
					,[PublicId]             	= @PublicId
			WHERE	[SysId] = @SysId
		END
