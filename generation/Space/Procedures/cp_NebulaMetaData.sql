...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_NebulaMetaData]
	 @Operation   	[INT]                	= 0
	,@Active      	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[NebulaMetaData]
			SET		 [Active]      	= @Active
					,[KeyPath]     	= @KeyPath
					,[KeyValue]    	= @KeyValue
