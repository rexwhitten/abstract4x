-- =============================================================================
-- Name:		cp_QubitMetaData
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:37:15 PM
-- Description:	Provides CRUD access to [Space].[dbo].[QubitMetaData]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_QubitMetaData]
	 @Operation  	[INT]                	= 0
	,@Active     	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[QubitMetaData]
			SET		 [Active]     	= @Active
					,[KeyPath]    	= @KeyPath
					,[KeyValue]   	= @KeyValue
					,[PublicId]   	= @PublicId
