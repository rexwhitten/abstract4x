...
-- Description:	Provides CRUD access to [Space].[dbo].[Moons]
--
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[Moons]
			SET		 [Active]           	= @Active
					,[CreateDate]       	= @CreateDate
					,[Is_ReadOnly]      	= @Is_ReadOnly
					,[LastModifiedDate] 	= @LastModifiedDate
					,[MoonStatusSysId]  	= @MoonStatusSysId
					,[MoonTypeSysId]    	= @MoonTypeSysId
					,[Path]             	= @Path
					,[PublicId]         	= @PublicId
			WHERE	[SysId] = @SysId
		END
