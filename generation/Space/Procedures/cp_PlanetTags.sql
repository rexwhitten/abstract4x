...
-- Created On:	10/26/2014 5:37:08 PM
-- Description:	Provides CRUD access to [Space].[dbo].[PlanetTags]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_PlanetTags]
	 @Operation   	[INT]             	= 0
	,@Active      	[BIT]             	= NULL
