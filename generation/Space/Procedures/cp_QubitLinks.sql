...
-- Created On:	10/26/2014 5:37:14 PM
-- Description:	Provides CRUD access to [Space].[dbo].[QubitLinks]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_QubitLinks]
	 @Operation        	[INT]                	= 0
	,@Active           	[BIT]                	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[QubitLinks]
			SET		 [Active]           	= @Active
					,[ChildQubitSysId]  	= @ChildQubitSysId
					,[CreateDate]       	= @CreateDate
					,[LastModifiedDate] 	= @LastModifiedDate
					,[LinkPath]         	= @LinkPath
					,[ParentQubitSysId] 	= @ParentQubitSysId
					,[PublicId]         	= @PublicId
			WHERE	[SysId] = @SysId
		END
