-- =============================================================================
-- Name:		cp_CharacterTags
-- Created By:	MGenerator.Tools.SqlGeneration.CrudProcedureGenerator (Generated)
-- Created On:	10/26/2014 5:36:49 PM
-- Description:	Provides CRUD access to [Space].[dbo].[CharacterTags]
--
...
-- =============================================================================
ALTER PROCEDURE [dbo].[cp_CharacterTags]
	 @Operation      	[INT]             	= 0
	,@Active         	[BIT]             	= NULL
...
AS
 ...
 BEGIN TRY 
	...
	IF( @Operation = 4 )
		BEGIN
			UPDATE	[Space].[dbo].[CharacterTags]
			SET		 [Active]         	= @Active
