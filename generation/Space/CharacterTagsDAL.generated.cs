namespace Space.Data.Space {
    ...
    public partial class CharacterTagsDAL : Space.Data.DataAccessBase {
        
        public CharacterTagsDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private CharacterTags Fill(System.Data.DataRow row) {
            CharacterTags obj = new CharacterTags();
        ...
        public virtual Collection<CharacterTags> SelectObjects(CharacterTags query) {
            Collection<CharacterTags> objs = new Collection<CharacterTags>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_CharacterTags");
        ...
        public virtual System.Data.DataSet Select(CharacterTags query) {
            this.Access.CreateProcedureCommand("ssp_CharacterTags");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pCharacterSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_CharacterTags");
        ...
        // Updates a Record
        public virtual int Update(CharacterTags query) {
            this.Access.CreateProcedureCommand("cp_CharacterTags");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(CharacterTags query) {
            this.Access.CreateProcedureCommand("cp_CharacterTags");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pCharacterSysId, string pTag, System.Nullable<System.DateTime> pCreateDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_CharacterTags");
        ...
        // Inserts a record
        public virtual int Insert(CharacterTags query) {
            this.Access.CreateProcedureCommand("cp_CharacterTags");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
