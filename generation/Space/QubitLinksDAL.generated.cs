namespace Space.Data.Space {
    ...
    public partial class QubitLinksDAL : Space.Data.DataAccessBase {
        
        public QubitLinksDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private QubitLinks Fill(System.Data.DataRow row) {
            QubitLinks obj = new QubitLinks();
            ...
            if ((row["ParentQubitSysId"] != System.DBNull.Value)) {
                obj.ParentQubitSysId = ((int?)(row["ParentQubitSysId"]));
            }
            if ((row["ChildQubitSysId"] != System.DBNull.Value)) {
                obj.ChildQubitSysId = ((int?)(row["ChildQubitSysId"]));
            }
        ...
        public virtual Collection<QubitLinks> SelectObjects(QubitLinks query) {
            Collection<QubitLinks> objs = new Collection<QubitLinks>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_QubitLinks");
        ...
        public virtual System.Data.DataSet Select(QubitLinks query) {
            this.Access.CreateProcedureCommand("ssp_QubitLinks");
            if (query.SysId == null) {
            ...
            if (query.ParentQubitSysId == null) {
                this.Access.AddParameter("ParentQubitSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ParentQubitSysId",query.ParentQubitSysId, ParameterDirection.Input);
            }
            if (query.ChildQubitSysId == null) {
                this.Access.AddParameter("ChildQubitSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ChildQubitSysId",query.ChildQubitSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentQubitSysId, System.Nullable<int> pChildQubitSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_QubitLinks");
            ...
            this.Access.AddParameter("ParentQubitSysId", pParentQubitSysId, ParameterDirection.Input);
            this.Access.AddParameter("ChildQubitSysId", pChildQubitSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(QubitLinks query) {
            this.Access.CreateProcedureCommand("cp_QubitLinks");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(QubitLinks query) {
            this.Access.CreateProcedureCommand("cp_QubitLinks");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentQubitSysId, System.Nullable<int> pChildQubitSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_QubitLinks");
        ...
        // Inserts a record
        public virtual int Insert(QubitLinks query) {
            this.Access.CreateProcedureCommand("cp_QubitLinks");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
