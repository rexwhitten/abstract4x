namespace Space.Data.Space {
    ...
    public partial class StarSectorTypesDAL : Space.Data.DataAccessBase {
        
        public StarSectorTypesDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private StarSectorTypes Fill(System.Data.DataRow row) {
            StarSectorTypes obj = new StarSectorTypes();
        ...
        public virtual Collection<StarSectorTypes> SelectObjects(StarSectorTypes query) {
            Collection<StarSectorTypes> objs = new Collection<StarSectorTypes>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_StarSectorTypes");
        ...
        public virtual System.Data.DataSet Select(StarSectorTypes query) {
            this.Access.CreateProcedureCommand("ssp_StarSectorTypes");
            if (query.SysId == null) {
        ...
        // Updates a Record
        public virtual int Update(StarSectorTypes query) {
            this.Access.CreateProcedureCommand("cp_StarSectorTypes");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(StarSectorTypes query) {
            this.Access.CreateProcedureCommand("cp_StarSectorTypes");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(StarSectorTypes query) {
            this.Access.CreateProcedureCommand("cp_StarSectorTypes");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
