namespace Space.Data.Space {
    ...
    public partial class TechTreeLinksDAL : Space.Data.DataAccessBase {
        
        public TechTreeLinksDAL() : 
                base("Space") {
        }
        
        // Returns a Hydrated POCO
        private TechTreeLinks Fill(System.Data.DataRow row) {
            TechTreeLinks obj = new TechTreeLinks();
            ...
            if ((row["ParentTechTreeSysId"] != System.DBNull.Value)) {
                obj.ParentTechTreeSysId = ((int?)(row["ParentTechTreeSysId"]));
            }
            if ((row["ChildTechTreeSysId"] != System.DBNull.Value)) {
                obj.ChildTechTreeSysId = ((int?)(row["ChildTechTreeSysId"]));
            }
        ...
        public virtual Collection<TechTreeLinks> SelectObjects(TechTreeLinks query) {
            Collection<TechTreeLinks> objs = new Collection<TechTreeLinks>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_TechTreeLinks");
        ...
        public virtual System.Data.DataSet Select(TechTreeLinks query) {
            this.Access.CreateProcedureCommand("ssp_TechTreeLinks");
            if (query.SysId == null) {
            ...
            if (query.ParentTechTreeSysId == null) {
                this.Access.AddParameter("ParentTechTreeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ParentTechTreeSysId",query.ParentTechTreeSysId, ParameterDirection.Input);
            }
            if (query.ChildTechTreeSysId == null) {
                this.Access.AddParameter("ChildTechTreeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("ChildTechTreeSysId",query.ChildTechTreeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentTechTreeSysId, System.Nullable<int> pChildTechTreeSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_TechTreeLinks");
            ...
            this.Access.AddParameter("ParentTechTreeSysId", pParentTechTreeSysId, ParameterDirection.Input);
            this.Access.AddParameter("ChildTechTreeSysId", pChildTechTreeSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(TechTreeLinks query) {
            this.Access.CreateProcedureCommand("cp_TechTreeLinks");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(TechTreeLinks query) {
            this.Access.CreateProcedureCommand("cp_TechTreeLinks");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Guid pPublicId, System.Nullable<int> pParentTechTreeSysId, System.Nullable<int> pChildTechTreeSysId, string pLinkPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_TechTreeLinks");
        ...
        // Inserts a record
        public virtual int Insert(TechTreeLinks query) {
            this.Access.CreateProcedureCommand("cp_TechTreeLinks");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
