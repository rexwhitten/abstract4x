namespace Space.Data.Space {
    ...
    public partial class StarsDAL : Space.Data.DataAccessBase {
        ...
        private Stars Fill(System.Data.DataRow row) {
            Stars obj = new Stars();
            if ((row["SysId"] != System.DBNull.Value)) {
                obj.SysId = ((int?)(row["SysId"]));
            }
            if ((row["StarStatusSysId"] != System.DBNull.Value)) {
                obj.StarStatusSysId = ((int?)(row["StarStatusSysId"]));
            }
            if ((row["StarTypeSysId"] != System.DBNull.Value)) {
                obj.StarTypeSysId = ((int?)(row["StarTypeSysId"]));
            }
        ...
        public virtual Collection<Stars> SelectObjects(Stars query) {
            Collection<Stars> objs = new Collection<Stars>();
...
while(e.MoveNext()) { 
 ...
 objs.Add(obj);
        ...
        public virtual System.Data.DataSet Select(System.Nullable<int> pSysId) {
            this.Access.CreateProcedureCommand("cp_Stars");
        ...
        public virtual System.Data.DataSet Select(Stars query) {
            this.Access.CreateProcedureCommand("ssp_Stars");
            if (query.SysId == null) {
            ...
            if (query.StarStatusSysId == null) {
                this.Access.AddParameter("StarStatusSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("StarStatusSysId",query.StarStatusSysId, ParameterDirection.Input);
            }
            if (query.StarTypeSysId == null) {
                this.Access.AddParameter("StarTypeSysId", null , ParameterDirection.Input);
            }
            else {
                this.Access.AddParameter("StarTypeSysId",query.StarTypeSysId, ParameterDirection.Input);
            }
        ...
        // Updates a Record
        public virtual int Update(System.Nullable<int> pSysId, System.Nullable<int> pStarStatusSysId, System.Nullable<int> pStarTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Stars");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            this.Access.AddParameter("SysId", pSysId, ParameterDirection.Input);
            this.Access.AddParameter("StarStatusSysId", pStarStatusSysId, ParameterDirection.Input);
            this.Access.AddParameter("StarTypeSysId", pStarTypeSysId, ParameterDirection.Input);
        ...
        // Updates a Record
        public virtual int Update(Stars query) {
            this.Access.CreateProcedureCommand("cp_Stars");
            this.Access.AddParameter("Operation", 4, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
        ...
        // Delete's a record
        public virtual int Delete(Stars query) {
            this.Access.CreateProcedureCommand("cp_Stars");
            this.Access.AddParameter("Operation", 6, ParameterDirection.Input);
            this.Access.AddParameter("SysId", query.SysId, ParameterDirection.Input);
            var value = this.Access.ExecuteNonQuery();
        ...
        // Inserts a record
        public virtual int Insert(System.Nullable<int> pSysId, System.Nullable<int> pStarStatusSysId, System.Nullable<int> pStarTypeSysId, System.Guid pPublicId, string pPath, System.Nullable<System.DateTime> pCreateDate, System.Nullable<System.DateTime> pLastModifiedDate, System.Nullable<bool> pIs_ReadOnly, System.Nullable<bool> pActive) {
            this.Access.CreateProcedureCommand("cp_Stars");
        ...
        // Inserts a record
        public virtual int Insert(Stars query) {
            this.Access.CreateProcedureCommand("cp_Stars");
            this.Access.AddParameter("Operation", 5, ParameterDirection.Input);
            if (query.SysId == null) {
                this.Access.AddParameter("SysId", null , ParameterDirection.Input);
